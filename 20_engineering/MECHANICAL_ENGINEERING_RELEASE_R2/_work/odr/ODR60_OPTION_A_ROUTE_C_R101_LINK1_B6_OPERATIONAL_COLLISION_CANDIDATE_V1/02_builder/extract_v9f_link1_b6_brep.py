#!/usr/bin/env python3
"""Read-only FreeCAD extraction of the exact six link1 V9F source Shapes."""
    ...
    try:
        ...
        for index, spec in enumerate(contract["objects"]):
            ...
            rows.append({
                ...
                "source_object_placement_diagnostic_only": matrix(obj.Placement),
        ...
        require(len(rows) == 6, "extractor did not emit exactly six objects")
        print(json.dumps({
            "schema": "ROUTE_C_LINK1_B6_TRANSIENT_BREP_EXTRACTION_V1",
            ...
            "objects": rows,
            "verdict": "LINK1_B6_TRANSIENT_BREP_EXTRACTION_PASS__OBJECT_PLACEMENT_NOT_REAPPLIED",
