...
SEGMENTS = [
    ...
    },
    {
        ...
        "sections": [
            ...
            ("poly", [j4_end, M4, K2, E1_J5, E2_J5, T1_J5], [55.0, 55.0, 55.0, 55.0]),
        ],
        "take_up_required_mm": 55.0*3.44,
        "take_up_capacity_mm": 55.0*math.radians(abs(j4_sweep)),
        "note": "V8 D1-A joint-local omega loop plus R55 external high-standoff bypass to the J5 wrap",
    },
    {
...
# Relief-end retention clamps are outside the measured 117.1-174.3 deg
# contact sector.  They retain the R66 loop without altering donor link2.
j1_relief_a = circle_point(J1_C, (1, 0, 0), (0, 1, 0), J1_R, 95.0)
j1_relief_b = circle_point(J1_C, (1, 0, 0), (0, 1, 0), J1_R, 195.0)
clamp_saddle("RC-CLP-J1-RELIEF-A", j1_relief_a,
             tangent_dir_circle((1, 0, 0), (0, 1, 0), 95.0, -1),
             "polymer", "base_link", "V8 D3 relief-end low-profile retention clamp A", width=10.0)
clamp_saddle("RC-CLP-J1-RELIEF-B", j1_relief_b,
             tangent_dir_circle((1, 0, 0), (0, 1, 0), 195.0, -1),
             "polymer", "base_link", "V8 D3 relief-end low-profile retention clamp B", width=10.0)
...
clamp_saddle("RC-CLP-L4-HIGH-E1", E1_J5, v_norm(v_sub(E2_J5, E1_J5)), "aluminum", "link4",
             "V8 D1-A high-bypass standoff clamp E1")
clamp_saddle("RC-CLP-L4-HIGH-E2", E2_J5, v_norm(v_sub(T1_J5, E2_J5)), "aluminum", "link4",
             "V8 D1-A high-bypass standoff clamp E2")
...
clamp_saddle("RC-CLP-J5-HIGH-W2", W2, v_norm(v_sub(W3, W2)), "aluminum", "link5",
             "V8 D1-A high-return standoff clamp W2")
clamp_saddle("RC-CLP-J5-HIGH-W3", W3, v_norm(v_sub(A6, W3)), "aluminum", "link5",
             "V8 D1-A high-return standoff clamp W3")
clamp_saddle("RC-CLP-J5-HIGH-A6", A6, v_norm(v_sub(H0, A6)), "aluminum", "link5",
             "V8 D1-A J6 entry-tangent standoff clamp A6")
...
CLAMPS = [
    ...
    ("CF-J1-REL-A", "base_link", j1_relief_a, "RELIEF_END", "2xM3 on V8 annulus cheek",
     "V8 D3 100 deg relief-end retention clamp"),
    ("CF-J1-REL-B", "base_link", j1_relief_b, "RELIEF_END", "2xM3 on V8 annulus cheek",
     "V8 D3 190 deg relief-end retention clamp"),
    ...
    ("CF-L4-HIGH-E1", "link4", E1_J5, "STANDOFF", "2xM3 on V8 high-bypass guide", "V8 D1 high-bypass clamp E1"),
    ("CF-L4-HIGH-E2", "link4", E2_J5, "STANDOFF", "2xM3 on V8 high-bypass guide", "V8 D1 high-bypass clamp E2"),
    ...
    ("CF-J5-HIGH-W2", "link5", W2, "STANDOFF", "2xM3 on V8 high-return guide", "V8 D1 high-return clamp W2"),
    ("CF-J5-HIGH-W3", "link5", W3, "STANDOFF", "2xM3 on V8 high-return guide", "V8 D1 high-return clamp W3"),
    ("CF-J5-HIGH-A6", "link5", A6, "STANDOFF", "2xM3 on V8 high-return guide", "V8 D1 J6-entry tangent clamp A6"),
