...
M4 = (M4[0], YC, 195.1)
# V8 D1-A: the full 9 mm bundle is moved out of the 5 mm link4/link3
# corridor.  All non-collinear corners below have enough straight-leg length
# to retain a true R55 fillet (no radius clamp below the 54 mm build rule).
K2 = (115.0, YC - 30.0, 270.0)
E1_J5 = (200.0, YC - 30.0, 275.0)
E2_J5 = (200.0, -90.0, 275.0)
...
SEGMENTS = [
    ...
    },
    {
        ...
        "note": ("V8 candidate-2 D1: J4 loop and explicit R55 host-transition fillet are "
                 "dual-host compliance; post-boundary high bypass is a link4-only fixed channel"),
    },
    {
...
J3_CARR_PT, J3_CARR_TAN = route_station_near("SEG-02_J2_GUIDED_U_LOOP_AND_LINK2_CHANNEL",
                                             (-140.0, YC, 147.0))
_l3_seed_dir = v_norm(v_sub(F4, M3))
_l3_seed_1 = v_add(M3, v_mul(_l3_seed_dir, v_dist(M3, F4)/3.0))
_l3_seed_2 = v_add(M3, v_mul(_l3_seed_dir, 2.0*v_dist(M3, F4)/3.0))
...
receipt = {
    ...
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
    "design_candidate_sequence": 2,
    "supersedes_candidate": "V8_LOOP1_D1A_D2A_D3A (rejected, immutable archive)",
    ...
    "candidate_2_changes": {
        "D1": "explicit J4 dual-host transition ending at a real link4 clamp; downstream section link4-only",
