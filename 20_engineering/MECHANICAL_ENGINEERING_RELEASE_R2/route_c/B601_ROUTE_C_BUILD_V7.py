...
OUT_FCSTD = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_GUIDED_DRESS_PACK_V7.FCStd")
OUT_STEP = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_GUIDED_DRESS_PACK_V7.step")
OUT_CENTERLINE = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_HARNESS_CENTERLINE_V7.json")
OUT_CLAMPS = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_CLAMP_AND_GUIDE_REGISTER_V7.csv")
OUT_MASS = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_MASS_DELTA_BY_LINK_CANDIDATES_V7.json")
OUT_RECEIPT = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_BUILD_RECEIPT_V7.json")
...
W2 = v_add(W1, v_mul(v_norm(v_sub((73.11, 89.04, 227.3), W1)), 140.0))
...
A6 = v_sub(H0, v_mul(j6_entry_tan, 120.0))
...
# FreeCAD build
# ==========================================================================
doc = App.newDocument("B601_ROUTE_C_GUIDED_DRESS_PACK_V7")
part_registry = []
part_objects = {}
receipt_parts = []
...
mass_delta_doc = {
    "schema": "B601_ROUTE_C_MASS_DELTA_BY_LINK_CANDIDATES_V7",
...
tot_cap = 0.0
centerline_doc = {
    "schema": "B601_ROUTE_C_HARNESS_CENTERLINE_V7",
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
    "frame_convention": {
...
receipt = {
    "schema": "B601_ROUTE_C_BUILD_RECEIPT_V7",
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
