# B601 Route-C Guided Dress Pack V9F single authorized fallback - headless FreeCAD build script.
...
# Architecture: CHAINLESS_TELESCOPING_TROMBONE_CASSETTE +
# R55_EXTERNAL_ANNULAR_FOLLOWER + LINK4_MOVING_TROLLEY.
# Run: FreeCADCmd.exe B601_ROUTE_C_BUILD_V9F.py
...
OUT_FCSTD = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_GUIDED_DRESS_PACK_V9F.FCStd")
OUT_STEP = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_GUIDED_DRESS_PACK_V9F.step")
OUT_CENTERLINE = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_HARNESS_CENTERLINE_V9F.json")
OUT_CLAMPS = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_CLAMP_AND_GUIDE_REGISTER_V9F.csv")
OUT_MASS = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_MASS_DELTA_BY_LINK_CANDIDATES_V9F.json")
OUT_RECEIPT = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_BUILD_RECEIPT_V9F.json")
...
P = {
    ...
    "j4_trombone_hard_stop_travel_mm": 100.0,
    "j4_trombone_center_x_mid_mm": -205.0,
    "j4_trombone_gain_mm_per_rad": 27.5,
    "j4_q_mid_rad": -0.15,
    "j4_telescope_stage_length_mm": 57.0,
    "j4_telescope_stage_count": 4,
    "j4_telescope_min_overlap_mm": 25.0,
    "j4_trombone_clear_mm": [12.0, 12.0],
...
# V9F single ODR-58 fallback: a chainless four-stage telescoping trombone
# cassette exchanges length with an external R55 annular follower.  The moving
# endpoint is authored on link4; the fixed entry and cassette are link3
# accessories.  No active/URDF DOF and no rotating electrical termination are
# introduced.  At every q4, dL_trombone/dq=+55 mm/rad and
# dL_annulus/dq=-55 mm/rad, so the single continuous bundle length is constant.
J4_SWITCH = (-112.074144, 81.625000, 102.428253)
J4_W1 = (-75.0, 90.0, 140.0)
J4_W2 = (-25.0, 104.0, 185.0)

# Accepted URDF J4 axis evaluated from rpy=-1.5708.  The nonzero third
# component is retained so the annular follower closes at sub-micron scale;
# replacing it with a nominal +Y axis creates an avoidable ~2e-4 mm mismatch.
J4_AXIS_EXTERNAL = (-1.400160, 210.0, 194.19934479280997)
J4_AXIS_DIR = (0.0, 0.999999999993254, -3.673205103e-6)
J4_ANNULUS_R = 55.0
J4_ANNULUS_E1 = (1.0, 0.0, 0.0)
J4_ANNULUS_E2 = v_cross(J4_AXIS_DIR, J4_ANNULUS_E1)
J4_ANNULUS_NORMAL = J4_AXIS_DIR
J4_ANNULUS_FIXED_ANGLE_DEG = 90.0
J4_QMAX_RAD = 1.57
J4_QMIN_FULL_RAD = -1.87
J4_QMIN_MISSION_RAD = -1.22001006794
J4_ANNULUS_BETA_Q0_DEG = math.degrees(math.radians(20.0) + J4_QMAX_RAD)
J4_ANNULUS_SWEEP_Q0_DEG = -J4_ANNULUS_BETA_Q0_DEG
J4_ANNULUS_ENTRY = circle_point(J4_AXIS_EXTERNAL, J4_ANNULUS_E1,
                                J4_ANNULUS_E2, J4_ANNULUS_R,
                                J4_ANNULUS_FIXED_ANGLE_DEG)

# Derive both trombone planes from the exact annular entry.  This preserves
# exact straight-line tangency at F_B/Eann and exact U-leg continuity instead
# of mixing rounded nominal y/z coordinates with the accepted URDF axis.
J4_TROMBONE_C0_X = (P["j4_trombone_center_x_mid_mm"] -
                    P["j4_trombone_gain_mm_per_rad"] *
                    (0.0 - P["j4_q_mid_rad"]))
J4_FIXED_B = (-100.0, J4_ANNULUS_ENTRY[1], J4_ANNULUS_ENTRY[2])
J4_PLANE_B_TANGENCY = (J4_TROMBONE_C0_X,
                       J4_FIXED_B[1], J4_FIXED_B[2])
J4_PLANE_A_TANGENCY = v_add(J4_PLANE_B_TANGENCY, (0.0, 46.0, 100.0))
J4_FIXED_A = (-100.0, J4_PLANE_A_TANGENCY[1], J4_PLANE_A_TANGENCY[2])
J4_TROMBONE_C0 = v_add(J4_PLANE_B_TANGENCY, (0.0, 23.0, 50.0))
J4_W3 = (150.0, 104.0, J4_FIXED_A[2])
J4_W4 = (150.0, J4_FIXED_A[1], J4_FIXED_A[2])

J4_TROMBONE_R = math.sqrt(23.0**2 + 50.0**2)  # 55.0363516 mm
J4_TROMBONE_E1 = (0.0, 23.0/J4_TROMBONE_R, 50.0/J4_TROMBONE_R)
J4_TROMBONE_E2 = (-1.0, 0.0, 0.0)
J4_TROMBONE_NORMAL = v_norm(v_cross(J4_TROMBONE_E1, J4_TROMBONE_E2))
J4_TROMBONE_SWEEP = 180.0

# Four independent rigid nested shells.  At q4=0 the straight leg is
# 109.125 mm, so three equal overlaps are 39.625 mm.  Under motion the shell
# translations are 0, 1/3, 2/3 and 1 times delta-x_C; no shell is stretched.
J4_STAGE_LENGTH = P["j4_telescope_stage_length_mm"]
J4_STAGE_COUNT = P["j4_telescope_stage_count"]
J4_LEG_LENGTH_Q0 = J4_FIXED_A[0] - J4_TROMBONE_C0_X
J4_STAGE_OVERLAP_Q0 = ((J4_STAGE_COUNT * J4_STAGE_LENGTH - J4_LEG_LENGTH_Q0) /
                       (J4_STAGE_COUNT - 1.0))
J4_STAGE_RIGHT_X_Q0 = [
    J4_FIXED_A[0] - i*(J4_STAGE_LENGTH-J4_STAGE_OVERLAP_Q0)
    for i in range(J4_STAGE_COUNT)
]
J4_STAGE_RADII = [(11.0, 9.8), (9.5, 8.4), (8.1, 7.0), (6.8, 5.6)]
J4_STAGE_MOTION = ["FIXED_LINK3", "ONE_THIRD_TRAVEL",
                   "TWO_THIRDS_TRAVEL", "FULL_TRAVEL"]

J4_ANNULUS_MOVING_Q0 = circle_point(
    J4_AXIS_EXTERNAL, J4_ANNULUS_E1, J4_ANNULUS_E2, J4_ANNULUS_R,
    J4_ANNULUS_FIXED_ANGLE_DEG + J4_ANNULUS_SWEEP_Q0_DEG)
J4_ANNULUS_EXIT_TAN_Q0 = tangent_dir_circle(
    J4_ANNULUS_E1, J4_ANNULUS_E2,
    J4_ANNULUS_FIXED_ANGLE_DEG + J4_ANNULUS_SWEEP_Q0_DEG, -1)
# Candidate C-channel covers the task envelope plus 5.144198 deg of declared
# design margin.  It is not full-hardware-range qualification: the latter
# needs 217.09748 deg and remains DEFERRED_HOLD.
J4_ANNULUS_GUIDE_SWEEP_DEG = -185.0
J4_ANNULUS_BETA_MISSION_MAX_DEG = math.degrees(
    math.radians(20.0) + J4_QMAX_RAD - J4_QMIN_MISSION_RAD)
J4_ANNULUS_BETA_FULL_MAX_DEG = math.degrees(
    math.radians(20.0) + J4_QMAX_RAD - J4_QMIN_FULL_RAD)
J4_ANNULUS_MISSION_MARGIN_DEG = (abs(J4_ANNULUS_GUIDE_SWEEP_DEG) -
                                 J4_ANNULUS_BETA_MISSION_MAX_DEG)

J4_TROMBONE_LENGTH_Q0 = (2.0*J4_LEG_LENGTH_Q0 +
                          math.pi*J4_TROMBONE_R)
J4_FIXED_BRIDGE_LENGTH = v_dist(J4_FIXED_B, J4_ANNULUS_ENTRY)
J4_ANNULUS_LENGTH_Q0 = (J4_ANNULUS_R *
                         math.radians(J4_ANNULUS_BETA_Q0_DEG))
J4_EXCHANGE_LENGTH_CONSTANT = (J4_TROMBONE_LENGTH_Q0 +
                               J4_FIXED_BRIDGE_LENGTH +
                               J4_ANNULUS_LENGTH_Q0)
J4_DOWNSTREAM_TANGENCY = v_add(J4_ANNULUS_MOVING_Q0,
                               v_mul(J4_ANNULUS_EXIT_TAN_Q0, 100.0))
J4_DOWNSTREAM_TURN_1 = (-100.0, 210.0, 340.0)
J4_DOWNSTREAM_TURN_2 = (-100.0, 58.0, 340.0)
J4_DOWNSTREAM_TURN_3 = (-100.0, -100.0, 285.0)
...
SEGMENTS = [
    ...
    {
        "id": "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER",
        "host_links": ["link3", "link4"],
        "sections": [
            ("poly", [J4_SWITCH, J4_W1, J4_W2, J4_W3, J4_W4, J4_FIXED_A],
             [55.0, 55.0, 55.0, 55.0]),
            ("poly", [J4_FIXED_A, J4_PLANE_A_TANGENCY], []),
            ("arc", (J4_TROMBONE_C0, J4_TROMBONE_NORMAL,
                     J4_TROMBONE_E1, J4_TROMBONE_E2,
                     J4_TROMBONE_R, 0.0, J4_TROMBONE_SWEEP)),
            ("poly", [J4_PLANE_B_TANGENCY, J4_FIXED_B], []),
            ("poly", [J4_FIXED_B, J4_ANNULUS_ENTRY], []),
            ("arc", (J4_AXIS_EXTERNAL, J4_ANNULUS_NORMAL,
                     J4_ANNULUS_E1, J4_ANNULUS_E2,
                     J4_ANNULUS_R, J4_ANNULUS_FIXED_ANGLE_DEG,
                     J4_ANNULUS_SWEEP_Q0_DEG)),
            ("poly", [J4_ANNULUS_MOVING_Q0, J4_DOWNSTREAM_TANGENCY,
                      J4_DOWNSTREAM_TURN_1, J4_DOWNSTREAM_TURN_2,
                      J4_DOWNSTREAM_TURN_3, E1_J5, E2_J5, T1_J5],
             [55.0, 55.0, 55.0, 55.0, 55.0, 55.0]),
        ],
        "take_up_required_mm": 55.0*3.44,
        "take_up_capacity_mm": 2.0*P["j4_trombone_hard_stop_travel_mm"],
        "note": ("V9F ODR-58 single fallback: four-stage chainless telescoping trombone, "
                 "moving R55.036 U-saddle, fixed F_B-to-annulus run, external R55 annular "
                 "follower with link4 moving trolley, and link4-only downstream conduit; "
                 "q4 length exchange is constant by construction"),
    },
    {
...
# FreeCAD build
# ==========================================================================
doc = App.newDocument("B601_ROUTE_C_GUIDED_DRESS_PACK_V9F")
part_registry = []
part_objects = {}
receipt_parts = []
part_axis_registry = {}
...
def oriented_box(name, center, size, x_dir, y_dir, material, host_link, role,
                 kind="hardware", motion_class=None):
    xd = v_norm(x_dir)
    yd = v_norm(y_dir)
...
def clamp_saddle(name, pt, direction, material, host_link, role, width=14.0,
                 bore_r=None, kind="clamp", motion_class=None):
    if bore_r is None:
    ...
    oriented_box(name, pt, (width, cross, cross), d, yd, material, host_link, role,
                 kind=kind, motion_class=motion_class)
...
def tube_shell_on_wire(name, wire, r_outer, r_inner, material, host_link, role, kind,
                       motion_class=None, overlap_disposition=None):
    ...
    if overlap_disposition is None:
...
def guide_tube_shell(name, center, normal, e1, e2, R, start_deg, sweep_deg,
    ...
    return tube_shell_on_wire(name, Part.Wire([edge]), r_outer, r_inner,
                              material, host_link, role, kind, motion_class,
                              overlap_disposition)
...
J4_FIX_PT, J4_FIX_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_FIXED_A)
J4_PA_PT, J4_PA_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_PLANE_A_TANGENCY)
J4_PB_PT, J4_PB_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_PLANE_B_TANGENCY)
J4_ANN_ENTRY_PT, J4_ANN_ENTRY_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_ANNULUS_ENTRY)
J4_ANN_MOV_PT, J4_ANN_MOV_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_ANNULUS_MOVING_Q0)
L4_01_PT, L4_01_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_DOWNSTREAM_TURN_1)
L4_E1_PT, L4_E1_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", J4_DOWNSTREAM_TURN_2)
L4_E2_PT, L4_E2_TAN = route_station_near(
    "SEG-04_J4_CHAINLESS_TROMBONE_EXTERNAL_ANNULAR_FOLLOWER", E2_J5)
...
clamp_saddle("RC-CLP-J4-FIX", J4_FIX_PT, J4_FIX_TAN, "aluminum", "link3",
             "CF-J4-F fixed clamp at chainless trombone Plane-A entry",
             motion_class="FIXED_LINK3")

# V9F ODR-58 single authorized fallback.  All solids are additive removable
# accessories; the accepted B601 bodies, joints, limits and URDF remain
# read-only.  The fixed approach is a split conduit ending tangentially at F_A.
guide_tube_poly_shell(
    "RC-GDE-J4-FIXED-APPROACH",
    [J4_SWITCH, J4_W1, J4_W2, J4_W3, J4_W4, J4_FIXED_A],
    [55.0, 55.0, 55.0, 55.0], 9.5, 7.2, "aluminum", "link3",
    "V9F fixed R55 split conduit to trombone Plane-A entry", "guide_channel",
    motion_class="FIXED_LINK3")
guide_tube_poly_shell(
    "RC-GDE-J4-FIXED-APPROACH-LINER",
    [J4_SWITCH, J4_W1, J4_W2, J4_W3, J4_W4, J4_FIXED_A],
    [55.0, 55.0, 55.0, 55.0], 7.2, 5.8, "polymer", "link3",
    "V9F replaceable low-friction liner to Plane-A entry", "liner",
    motion_class="FIXED_LINK3")

# Two parallel four-stage telescope legs.  Each stage is a separate rigid
# shell at its q4=0 placement.  Radial gaps make the overlapping volumes
# physically disjoint, while stage-4 still clears the frozen OD10 upper bundle.
for plane_name, plane_pt in (("A", J4_PLANE_A_TANGENCY),
                             ("B", J4_PLANE_B_TANGENCY)):
    for stage_idx, (right_x, radii, motion) in enumerate(
            zip(J4_STAGE_RIGHT_X_Q0, J4_STAGE_RADII, J4_STAGE_MOTION), 1):
        left_x = right_x - J4_STAGE_LENGTH
        p_left = (left_x, plane_pt[1], plane_pt[2])
        p_right = (right_x, plane_pt[1], plane_pt[2])
        stage_wire = Part.Wire([Part.makeLine(fc_vec(p_left), fc_vec(p_right))])
        tube_shell_on_wire(
            "RC-TEL-J4-%s-STAGE-%d" % (plane_name, stage_idx), stage_wire,
            radii[0], radii[1], "aluminum", "link3",
            ("V9F Plane-%s rigid nested telescope stage %d/4; "
             "q4=0 left/right x %.3f/%.3f mm" %
             (plane_name, stage_idx, left_x, right_x)),
            "telescope_stage", motion_class=motion,
            overlap_disposition=(
                "RADIALLY_DISJOINT_NESTED_SHELL__AXIAL_OVERLAP_Q0_%.3f_MM__"
                "BUNDLE_UPPER_RADIUS_5_MM" % J4_STAGE_OVERLAP_Q0))

# Linear rail and hard stops constrain the translating U-saddle cassette.  The
# q4=0 carriage x=-209.125 mm sits inside physical stops [-255,-155] mm; full
# theoretical centers [-252.3,-157.7] retain 2.7 mm at each end.
j4_rail_center = (P["j4_trombone_center_x_mid_mm"],
                  J4_TROMBONE_C0[1], J4_TROMBONE_C0[2]-22.0)
oriented_box("RC-TRK-J4-TROMBONE-RAIL", j4_rail_center, (110.0, 6.0, 6.0),
             (1, 0, 0), (0, 1, 0), "aluminum", "link3",
             "V9F passive trombone rail; hard-stop centers x=-255..-155",
             kind="guide_rail", motion_class="FIXED_LINK3")
# Removable mounting spine and three pads provide a visible source-level load
# path from the rail into candidate link3 attachment stations.  Pad fastener
# pattern, local link allowable and MoS are intentionally not asserted.
oriented_box("RC-BRK-J4-RAIL-SPINE",
             (P["j4_trombone_center_x_mid_mm"], J4_TROMBONE_C0[1],
              J4_TROMBONE_C0[2]-28.0),
             (120.0, 18.0, 6.0), (1, 0, 0), (0, 1, 0),
             "aluminum", "link3",
             "V9F removable trombone rail mounting spine; local M3 allowable HOLD",
             kind="mounting_spine", motion_class="FIXED_LINK3")
for pad_idx, pad_x in enumerate((-250.0, -205.0, -160.0), 1):
    oriented_box("RC-BRK-J4-RAIL-PAD-%d" % pad_idx,
                 (pad_x, J4_TROMBONE_C0[1], J4_TROMBONE_C0[2]-34.0),
                 (18.0, 28.0, 6.0), (1, 0, 0), (0, 1, 0),
                 "aluminum", "link3",
                 "V9F removable rail mounting pad %d/3; fastener definition/MoS HOLD" % pad_idx,
                 kind="mounting_pad", motion_class="FIXED_LINK3")
for stop_name, stop_x in (("NEG", -255.0), ("POS", -155.0)):
    oriented_box("RC-TRK-J4-STOP-" + stop_name,
                 (stop_x, J4_TROMBONE_C0[1], J4_TROMBONE_C0[2]-16.0),
                 (5.0, 18.0, 20.0), (1, 0, 0), (0, 1, 0),
                 "aluminum", "link3",
                 "V9F trombone hard stop x=%.1f mm" % stop_x,
                 kind="hard_stop", motion_class="FIXED_LINK3")
oriented_box("RC-CAR-J4-TROMBONE", (J4_TROMBONE_C0[0],
                                     J4_TROMBONE_C0[1],
                                     J4_TROMBONE_C0[2]-14.0),
             (30.0, 20.0, 14.0), (1, 0, 0), (0, 1, 0),
             "aluminum", "link3",
             "V9F passive q4-driven U-saddle carriage at q4=0",
             kind="carrier", motion_class="FULL_TRAVEL")

guide_tube_shell("RC-GDE-J4-TROMBONE-U", J4_TROMBONE_C0,
                 J4_TROMBONE_NORMAL, J4_TROMBONE_E1, J4_TROMBONE_E2,
                 J4_TROMBONE_R, 0.0, J4_TROMBONE_SWEEP,
                 9.5, 7.2, "aluminum", "link3",
                 "V9F translating R55.036 split U-saddle", "guide_saddle",
                 motion_class="FULL_TRAVEL")
guide_tube_shell("RC-GDE-J4-TROMBONE-U-LINER", J4_TROMBONE_C0,
                 J4_TROMBONE_NORMAL, J4_TROMBONE_E1, J4_TROMBONE_E2,
                 J4_TROMBONE_R, 0.0, J4_TROMBONE_SWEEP,
                 7.2, 5.8, "polymer", "link3",
                 "V9F translating replaceable U-saddle liner", "liner",
                 motion_class="FULL_TRAVEL")

# Plane-B leaves the telescope along +X and is exactly tangent/continuous with
# the annular entry derived from the accepted J4 axis.
guide_tube_poly_shell("RC-GDE-J4-B-TO-ANNULUS",
                      [J4_FIXED_B, J4_ANNULUS_ENTRY], [],
                      9.5, 7.2, "aluminum", "link3",
                      "V9F fixed Plane-B bridge to annular entry", "guide_channel",
                      motion_class="FIXED_LINK3")
guide_tube_poly_shell("RC-GDE-J4-B-TO-ANNULUS-LINER",
                      [J4_FIXED_B, J4_ANNULUS_ENTRY], [],
                      7.2, 5.8, "polymer", "link3",
                      "V9F fixed replaceable bridge liner", "liner",
                      motion_class="FIXED_LINK3")
clamp_saddle("RC-CLP-J4-B", J4_FIXED_B, (1.0, 0.0, 0.0),
             "aluminum", "link3", "CF-J4-B fixed Plane-B clamp",
             motion_class="FIXED_LINK3")
clamp_saddle("RC-CLP-J4-ANN-ENTRY", J4_ANNULUS_ENTRY, (1.0, 0.0, 0.0),
             "aluminum", "link3", "CF-J4-ANN-E fixed annular-entry clamp",
             motion_class="FIXED_LINK3")

# Physical annular channel is deliberately mission-bounded: 185 deg from the
# +90 deg fixed entry.  The q4=0 bundle centerline only occupies 109.954 deg;
# full q4 hardware range requires 217.09748 deg and remains DEFERRED_HOLD.
guide_tube_shell("RC-GDE-J4-ANNULAR-FOLLOWER", J4_AXIS_EXTERNAL,
                 J4_ANNULUS_NORMAL, J4_ANNULUS_E1, J4_ANNULUS_E2,
                 J4_ANNULUS_R, J4_ANNULUS_FIXED_ANGLE_DEG,
                 J4_ANNULUS_GUIDE_SWEEP_DEG, 9.5, 7.2,
                 "aluminum", "link3",
                 ("V9F R55 external annular C-channel; mission-bounded 185deg; "
                  "full-range coverage DEFERRED_HOLD"), "guide_saddle",
                 motion_class="FIXED_LINK3")
guide_tube_shell("RC-GDE-J4-ANNULAR-FOLLOWER-LINER", J4_AXIS_EXTERNAL,
                 J4_ANNULUS_NORMAL, J4_ANNULUS_E1, J4_ANNULUS_E2,
                 J4_ANNULUS_R, J4_ANNULUS_FIXED_ANGLE_DEG,
                 J4_ANNULUS_GUIDE_SWEEP_DEG, 7.2, 5.8,
                 "polymer", "link3",
                 "V9F mission-bounded replaceable annular follower liner",
                 "liner", motion_class="FIXED_LINK3")

# A bounded support probe replaces the earlier in-plane floating pads with a
# continuous removable load path to a candidate Link-3 root station.  The
# root interface is intentional host contact; all non-host frozen clearances
# remain positive in the five mandatory key states.  Section allowables,
# buckling and root-fastener margins remain qualification holds.
j4_ann_support_registry = []
j4_spine_r0 = (-175.0, 35.0, J4_AXIS_EXTERNAL[2])
j4_spine_s0 = (-175.0, 65.0, J4_AXIS_EXTERNAL[2])
j4_spine_s1 = (-175.0, 190.0, J4_AXIS_EXTERNAL[2])
for support_part, p0, p1, section in [
        ("RC-BRK-J4-ANN-ROOT-NECK", j4_spine_r0, j4_spine_s0,
         (14.0, 14.0)),
        ("RC-BRK-J4-ANN-MAIN-SPINE", j4_spine_s0, j4_spine_s1,
         (20.0, 12.0))]:
    support_dir = v_norm(v_sub(p1, p0))
    support_len = v_dist(p0, p1)
    support_center = v_mul(v_add(p0, p1), 0.5)
    oriented_box(support_part, support_center,
                 (support_len, section[0], section[1]), support_dir,
                 J4_ANNULUS_E1, "aluminum", "link3",
                 ("V9F removable annular-guide cantilever load path; "
                  "root fastener, local allowable and buckling MoS HOLD"),
                 kind="mounting_spine", motion_class="FIXED_LINK3")
oriented_box("RC-BRK-J4-ANN-SPINE-HUB", j4_spine_s1,
             (24.0, 20.0, 24.0), J4_ANNULUS_E1, J4_AXIS_DIR,
             "aluminum", "link3",
             "V9F three-arm annular-support hub; local allowable/MoS HOLD",
             kind="mounting_hub", motion_class="FIXED_LINK3")

j4_ann_support_angles = [("UPPER", 75.0), ("MID", -2.5), ("LOWER", -80.0)]
for support_name, support_angle in j4_ann_support_angles:
    guide_center = circle_point(J4_AXIS_EXTERNAL, J4_ANNULUS_E1,
                                J4_ANNULUS_E2, J4_ANNULUS_R,
                                support_angle)
    radial = v_norm(v_sub(guide_center, J4_AXIS_EXTERNAL))
    arm_back = v_sub(guide_center, v_mul(J4_AXIS_DIR, 20.0))
    saddle_center = v_sub(guide_center, v_mul(J4_AXIS_DIR, 7.0))
    arm_dir = v_norm(v_sub(arm_back, j4_spine_s1))
    arm_side = v_norm(v_cross(J4_AXIS_DIR, arm_dir))
    arm_len = v_dist(j4_spine_s1, arm_back)
    arm_part = "RC-BRK-J4-ANN-SUPPORT-" + support_name + "-ARM"
    oriented_box(arm_part, v_mul(v_add(j4_spine_s1, arm_back), 0.5),
                 (arm_len, 16.0, 8.0), arm_dir, arm_side,
                 "aluminum", "link3",
                 ("V9F annular support arm %s at %.3fdeg; local allowable, "
                  "buckling and joint definition HOLD" %
                  (support_name, support_angle)),
                 kind="guide_support_arm", motion_class="FIXED_LINK3")
    post_part = "RC-BRK-J4-ANN-SUPPORT-" + support_name + "-POST"
    oriented_box(post_part, v_mul(v_add(arm_back, saddle_center), 0.5),
                 (v_dist(arm_back, saddle_center), 12.0, 10.0),
                 J4_AXIS_DIR, radial, "aluminum", "link3",
                 "V9F short axial support post to annular guide saddle",
                 kind="guide_support_post", motion_class="FIXED_LINK3")
    tangent = tangent_dir_circle(J4_ANNULUS_E1, J4_ANNULUS_E2,
                                 support_angle, -1)
    saddle_part = "RC-BRK-J4-ANN-SUPPORT-" + support_name + "-SADDLE"
    oriented_box(saddle_part, saddle_center, (8.0, 20.0, 20.0),
                 J4_AXIS_DIR, tangent, "aluminum", "link3",
                 ("V9F removable annular guide saddle %s; intentional guide "
                  "interface; fastener definition/MoS HOLD" % support_name),
                 kind="guide_support_saddle", motion_class="FIXED_LINK3")
    j4_ann_support_registry.append({
        "clamp_id": "GS-J4-ANN-" + support_name,
        "part": saddle_part,
        "point": saddle_center,
        "angle_deg": support_angle,
    })

follower_radial_q0 = v_norm(v_sub(J4_ANNULUS_MOVING_Q0, J4_AXIS_EXTERNAL))
follower_trolley_center_q0 = v_add(J4_ANNULUS_MOVING_Q0,
                                   v_mul(follower_radial_q0, 15.0))
oriented_box("RC-CAR-J4-FOLLOWER-TROLLEY", follower_trolley_center_q0,
             (24.0, 14.0, 10.0), J4_ANNULUS_EXIT_TAN_Q0,
             follower_radial_q0, "aluminum", "link4",
             "V9F link4-owned annular follower trolley at q4=0",
             kind="carrier", motion_class="FOLLOWER_LINK4")
clamp_saddle("RC-CLP-J4-FOLLOWER", J4_ANNULUS_MOVING_Q0,
             J4_ANNULUS_EXIT_TAN_Q0, "aluminum", "link4",
             "CM-J4-FOLLOWER moving endpoint clamp on link4 trolley",
             motion_class="FOLLOWER_LINK4")

# Link4-only external downstream route to the frozen J5 interface.  This is a
# q4=0 emitted configuration; all points after the follower are link4-owned.
l4_downstream_points = [J4_ANNULUS_MOVING_Q0, J4_DOWNSTREAM_TANGENCY,
                        J4_DOWNSTREAM_TURN_1, J4_DOWNSTREAM_TURN_2,
                        J4_DOWNSTREAM_TURN_3, E1_J5, E2_J5, T1_J5]
l4_clamp_pt = L4_01_PT
clamp_saddle("RC-CLP-L4-01", L4_01_PT, L4_01_TAN, "aluminum", "link4",
             "CF-L4-01 fixed clamp at external turn 1",
             motion_class="FIXED_LINK4")
guide_tube_poly_shell("RC-GDE-J5-HIGH-BYPASS", l4_downstream_points,
                      [55.0, 55.0, 55.0, 55.0, 55.0, 55.0],
                      9.5, 7.2, "aluminum", "link4",
                      "V9F link4-only external R55 split conduit", "guide_channel",
                      motion_class="FIXED_LINK4")
guide_tube_poly_shell("RC-GDE-J5-HIGH-BYPASS-LINER", l4_downstream_points,
                      [55.0, 55.0, 55.0, 55.0, 55.0, 55.0],
                      7.2, 5.8, "polymer", "link4",
                      "V9F link4-only replaceable low-friction liner shell", "liner",
                      motion_class="FIXED_LINK4")
guide_support_saddle("RC-GSP-L4-HIGH-E1", L4_E1_PT, L4_E1_TAN,
                     "aluminum", "link4",
                     "V9F external downstream conduit support at turn 2")
guide_support_saddle("RC-GSP-L4-HIGH-E2", L4_E2_PT, L4_E2_TAN,
                     "aluminum", "link4",
                     "V9F external downstream conduit support before J5")
...
CLAMPS = [
    ...
    ("CF-J4-F", "link3", J4_FIX_PT, "FIXED", "2xM3 on removable Plane-A bracket; definition/torque HOLD", "V9F fixed clamp at chainless telescope Plane-A entry"),
    ("CG-J4-U", "link3", J4_TROMBONE_C0, "GUIDE_SADDLE", "carriage-to-U-saddle interface; definition/torque HOLD", "V9F q4-generated translating R55.036 U-saddle datum at q4=0"),
    ("CF-J4-B", "link3", J4_FIXED_B, "FIXED", "2xM3 on removable Plane-B bracket; definition/torque HOLD", "V9F fixed Plane-B clamp after telescope return"),
    ("CF-J4-ANN-E", "link3", J4_ANNULUS_ENTRY, "FIXED", "2xM3 on removable annular-entry bracket; definition/torque HOLD", "V9F exact fixed entry to R55 annular channel"),
    ("CM-J4-FOLLOWER", "link4", J4_ANNULUS_MOVING_Q0, "MOVING_FOLLOWER", "2xM3 on link4 follower trolley; contact/torque HOLD", "V9F link4 follower closure point at q4=0"),
    ("CF-L4-01", "link4", l4_clamp_pt, "FIXED", "2xM3 on external split conduit; torque HOLD", "V9F link4 external turn-1 clamp"),
    ("GS-L4-HIGH-E1", "link4", L4_E1_PT, "GUIDE_SUPPORT", "2xM3 on V9F high-bypass guide", "conduit-axis support E1; not a cable clamp"),
    ("GS-L4-HIGH-E2", "link4", L4_E2_PT, "GUIDE_SUPPORT", "2xM3 on V9F high-bypass guide", "conduit-axis support E2; not a cable clamp"),
...
for support_rec in j4_ann_support_registry:
    CLAMPS.append((
        support_rec["clamp_id"], "link3", support_rec["point"],
        "GUIDE_SADDLE", "candidate removable M3 support pad; definition/MoS HOLD",
        ("V9F external annular guide support at %.9fdeg; structural support only, "
         "does not enter cable bore" % support_rec["angle_deg"])))
...
CAD_PART_BY_CLAMP_ID = {
    ...
    "CF-J4-F": "RC-CLP-J4-FIX", "CG-J4-U": "RC-GDE-J4-TROMBONE-U",
    "CF-J4-B": "RC-CLP-J4-B", "CF-J4-ANN-E": "RC-CLP-J4-ANN-ENTRY",
    "CM-J4-FOLLOWER": "RC-CLP-J4-FOLLOWER",
...
for support_rec in j4_ann_support_registry:
    CAD_PART_BY_CLAMP_ID[support_rec["clamp_id"]] = support_rec["part"]
...
mass_delta_doc = {
    "schema": "B601_ROUTE_C_MASS_DELTA_BY_LINK_CANDIDATES_V9F",
...
def section_to_json(sec):
    kind = sec[0]
    if kind == "poly":
        return {"type": "polyline", "points": [[round(c, 12) for c in p] for p in sec[1]],
                "corner_fillet_radii_mm": sec[2]}
    if kind == "arc":
        c, n, e1, e2, R, a0, sw = sec[1]
        return {"type": "arc", "center": [round(v, 12) for v in c], "normal": list(n),
                "basis_e1": list(e1), "basis_e2": list(e2), "radius_mm": R,
                "start_angle_deg": round(a0, 12), "sweep_deg": round(sw, 12)}
    if kind == "helix":
        o, ax, e1, e2, R, pitch, a0, sw = sec[1]
        return {"type": "helix", "origin": [round(v, 12) for v in o], "axis": list(ax),
...
centerline_doc = {
    "schema": "B601_ROUTE_C_HARNESS_CENTERLINE_V9F",
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
    "design_candidate_sequence": 1,
    "owner_authority": {"decision_id": "ODR-58",
                        "input_manifest_sha256": INPUT_MANIFEST_SHA256},
    "architecture": "CHAINLESS_TELESCOPING_TROMBONE_CASSETTE__R55_EXTERNAL_ANNULAR_FOLLOWER__LINK4_MOVING_TROLLEY",
    "frame_convention": {
    ...
    "j3_carrier_legacy_preserved": {
        ...
        "pitch_mm": 20.0,
        "cross_section_inner_mm": [10.0, 16.0],
        "scope": "unchanged upstream J3 hardware; not part of the V9F J4 fallback",
    },
    "j4_trombone_annular_follower": {
        "id": "J4-CHAINLESS-TROMBONE-ANNULAR-FOLLOWER",
        "type": "four-stage rigid nested dual-leg trombone plus external R55 annular follower and link4 trolley",
        "motion_authority": "q4-generated kinematic design law; no active robot DOF",
        "q4_trombone_law": "x_C_mm = -205.0 - 27.5*(q4_rad + 0.15)",
        "q4_annulus_law": "beta_rad = radians(20.0) + (1.57 - q4_rad); alpha_m = radians(90.0) - beta_rad",
        "q4_full_hardware_limits_rad": [J4_QMIN_FULL_RAD, J4_QMAX_RAD],
        "q4_mission_interval_rad": [J4_QMIN_MISSION_RAD, 0.0],
        "center_x_at_qmin_full_mm": (-205.0 - 27.5*(J4_QMIN_FULL_RAD+0.15)),
        "center_x_at_q0_mm": J4_TROMBONE_C0_X,
        "center_x_at_qmax_full_mm": (-205.0 - 27.5*(J4_QMAX_RAD+0.15)),
        "center_x_interval_full_mm": [-252.3, -157.7],
        "hard_stop_center_x_mm": [-255.0, -155.0],
        "hard_stop_margin_each_end_mm": 2.7,
        "physical_travel_mm": P["j4_trombone_hard_stop_travel_mm"],
        "full_hardware_required_travel_mm": 94.6,
        "mission_required_travel_mm": abs(
            J4_TROMBONE_C0_X - (-205.0-27.5*(J4_QMIN_MISSION_RAD+0.15))),
        "take_up_rule": "cable take-up capacity = 2 x physical carriage travel",
        "take_up_capacity_mm": 2.0*P["j4_trombone_hard_stop_travel_mm"],
        "take_up_required_mm": 55.0*P["joint_ranges_rad"]["J4"],
        "trombone_u_radius_mm": J4_TROMBONE_R,
        "plane_A_fixed_point_mm": list(J4_FIXED_A),
        "plane_B_fixed_point_mm": list(J4_FIXED_B),
        "trombone_center_q0_mm": list(J4_TROMBONE_C0),
        "four_stage_telescope": {
            "stage_count_per_leg": J4_STAGE_COUNT,
            "stage_length_mm": J4_STAGE_LENGTH,
            "q0_leg_length_mm": J4_LEG_LENGTH_Q0,
            "q0_overlap_mm": J4_STAGE_OVERLAP_Q0,
            "minimum_overlap_full_range_mm": 25.23333333333333,
            "minimum_overlap_requirement_mm": P["j4_telescope_min_overlap_mm"],
            "stage_right_x_q0_mm": J4_STAGE_RIGHT_X_Q0,
            "stages": [
                {"stage": i+1, "r_outer_mm": radii[0], "r_inner_mm": radii[1],
                 "motion_class": motion,
                 "anti_rotation_key": "REQUIRED_CANDIDATE__NOT_SOLID_EMITTED__HOLD",
                 "interstage_retention_overlap_stop": "REQUIRED_CANDIDATE__NOT_SOLID_EMITTED__HOLD"}
                for i, (radii, motion) in enumerate(zip(J4_STAGE_RADII,
                                                        J4_STAGE_MOTION))
            ],
            "motion_rule": "stage translations relative q4=0 are [0, dx/3, 2dx/3, dx]; rigid translation only; no scaled or stretched parts",
            "anti_rotation_and_interstage_retention": "FUNCTIONAL_REQUIREMENT_REGISTERED__NOT_SOLID_EMITTED__DETAIL_DESIGN_AND_QUALIFICATION_HOLD",
        },
        "annular_follower": {
            "axis_origin_A0_mm": list(J4_AXIS_EXTERNAL),
            "axis_direction_A0": list(J4_AXIS_DIR),
            "basis_e1": list(J4_ANNULUS_E1),
            "basis_e2": list(J4_ANNULUS_E2),
            "radius_mm": J4_ANNULUS_R,
            "fixed_entry_mm": list(J4_ANNULUS_ENTRY),
            "moving_endpoint_q0_mm": list(J4_ANNULUS_MOVING_Q0),
            "q0_bundle_sweep_deg": J4_ANNULUS_SWEEP_Q0_DEG,
            "physical_guide_sweep_deg": J4_ANNULUS_GUIDE_SWEEP_DEG,
            "mission_beta_max_deg": J4_ANNULUS_BETA_MISSION_MAX_DEG,
            "mission_guide_margin_deg": J4_ANNULUS_MISSION_MARGIN_DEG,
            "full_hardware_beta_max_deg": J4_ANNULUS_BETA_FULL_MAX_DEG,
            "full_hardware_guide_margin_deg": (abs(J4_ANNULUS_GUIDE_SWEEP_DEG)-
                                                J4_ANNULUS_BETA_FULL_MAX_DEG),
            "full_hardware_coverage_status": "DEFERRED_HOLD",
            "follower_contact_status": "TORSION_NOT_FORCED_BY_TOPOLOGY__FOLLOWER_CONTACT_QUALIFICATION_HOLD",
        },
        "constant_length_proof": {
            "trombone_length_rule": "L_trom = 2*(x_F-x_C) + pi*R_U; dL_trom/dq4 = +55 mm/rad",
            "annulus_length_rule": "L_ann = 55*beta_rad; dL_ann/dq4 = -55 mm/rad",
            "fixed_bridge_rule": "L_bridge = norm(F_B-Eann), constant and exactly collinear with annulus entry tangent",
            "q0_trombone_length_mm": J4_TROMBONE_LENGTH_Q0,
            "fixed_bridge_length_mm": J4_FIXED_BRIDGE_LENGTH,
            "q0_annulus_length_mm": J4_ANNULUS_LENGTH_Q0,
            "exchange_subsystem_constant_length_mm": J4_EXCHANGE_LENGTH_CONSTANT,
            "derivative_sum_mm_per_rad": 0.0,
            "machine_residual_tolerance_required_mm": 1.0e-6,
        },
        "single_bundle_not_branches": True,
        "bundle_upper_diameter_mm": P["bundle_od_upper_mm"],
        "installed_bundle_resistance_torque_status": "HOLD_UNKNOWN_TORSION",
        "qualification_state": "SOURCE_ONLY_DESIGN_CANDIDATE__NO_GATE_OR_RELEASE_CREDIT",
...
for seg, srep in zip(SEGMENTS, segment_reports):
    centerline_doc["segments"].append({
        ...
        "path_length_mm": round(srep["path_length_mm"], 12),
        "take_up_required_mm": round(seg["take_up_required_mm"], 12),
        "take_up_capacity_mm": round(seg["take_up_capacity_mm"], 12),
        "note": seg["note"],
    })
    tot_req += seg["take_up_required_mm"]
    tot_cap += seg["take_up_capacity_mm"]
centerline_doc["take_up_summary"] = {
    "required_total_mm": round(tot_req, 12),
    "capacity_total_mm": round(tot_cap, 12),
    "margin_mm": round(tot_cap - tot_req, 12),
    "margin_percent_of_required": round(100.0*(tot_cap - tot_req)/tot_req, 12) if tot_req > 0 else None,
}
...
receipt = {
    "schema": "B601_ROUTE_C_BUILD_RECEIPT_V9F",
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
    "design_candidate_sequence": 1,
    "architecture": "CHAINLESS_TELESCOPING_TROMBONE_CASSETTE__R55_EXTERNAL_ANNULAR_FOLLOWER__LINK4_MOVING_TROLLEY",
    "supersedes_candidate": "V9_PRIMARY_TOPOLOGY_INVALID (immutable negative lineage); V8 remains immutable history",
    ...
    "authority": "ODR-58 single technically distinct fallback; DESIGN_CANDIDATE only",
    "verdict": "SOURCE_ONLY_DESIGN_CANDIDATE__NO_GATE_PASS__NO_RELEASE_CREDIT",
    ...
    "v9f_single_fallback_changes": {
        "J4_topology": "V9 primary articulated carrier removed; one continuous bundle uses two four-stage rigid nested telescope legs, a translating R55.036 U-saddle, a fixed bridge and an external R55 annular follower",
        "exact_axis": {"origin_A0_mm": list(J4_AXIS_EXTERNAL),
                       "direction_A0": list(J4_AXIS_DIR),
                       "basis_e1": list(J4_ANNULUS_E1),
                       "basis_e2": list(J4_ANNULUS_E2)},
        "passive_motion": "x_C_mm=-205-27.5*(q4+0.15); beta_rad=radians(20)+(1.57-q4); no active or URDF DOF",
        "constant_length": {
            "exchange_subsystem_length_mm": J4_EXCHANGE_LENGTH_CONSTANT,
            "dL_trombone_dq_mm_per_rad": 55.0,
            "dL_annulus_dq_mm_per_rad": -55.0,
            "derivative_residual_mm_per_rad": 0.0,
            "required_numeric_residual_tolerance_mm": 1.0e-6,
        },
        "telescope": {
            "stage_count_per_leg": J4_STAGE_COUNT,
            "stage_length_mm": J4_STAGE_LENGTH,
            "q0_overlap_mm": J4_STAGE_OVERLAP_Q0,
            "minimum_overlap_full_range_mm": 25.23333333333333,
            "minimum_required_overlap_mm": P["j4_telescope_min_overlap_mm"],
            "motion_classes": J4_STAGE_MOTION,
            "radial_shell_pairs_mm": J4_STAGE_RADII,
            "anti_rotation_keys_and_overlap_stops": "FUNCTIONAL_REQUIREMENT_REGISTERED__NOT_SOLID_EMITTED__DETAIL_DESIGN_AND_QUALIFICATION_HOLD",
        },
        "hard_stops": {"center_x_mm": [-255.0, -155.0],
                       "theoretical_center_interval_mm": [-252.3, -157.7],
                       "margin_each_end_mm": 2.7},
        "annular_guide": {
            "physical_sweep_deg": J4_ANNULUS_GUIDE_SWEEP_DEG,
            "mission_beta_max_deg": J4_ANNULUS_BETA_MISSION_MAX_DEG,
            "mission_margin_deg": J4_ANNULUS_MISSION_MARGIN_DEG,
            "full_hardware_beta_max_deg": J4_ANNULUS_BETA_FULL_MAX_DEG,
            "full_hardware_margin_deg": (abs(J4_ANNULUS_GUIDE_SWEEP_DEG)-
                                         J4_ANNULUS_BETA_FULL_MAX_DEG),
            "full_hardware_range_status": "DEFERRED_HOLD",
        },
        "host_boundary": "CM-J4-FOLLOWER is the exact q4=0 link4-owned moving endpoint; all downstream conduit is link4-owned",
        "load_path": "removable rail spine/pads plus a continuous Link-3 root-neck/main-spine/hub and three annular-guide arm/post/saddle branches are emitted source geometry; M3 definition, buckling and local allowable are HOLD",
        "preserved": "V9F does not alter accepted URDF, vendor links, M3R, Gripper R1, Solar R2, Full-Flex authority or Route-B/V8 evidence",
        "qualification_boundary": "follower contact/preload, full-range annular coverage, local fastener strength, installed-bundle restoring torque, launch retention, tribology and space-environment qualification remain explicit holds",
    },
    "holds": [
        "FULL_HARDWARE_RANGE_ANNULAR_GUIDE_COVERAGE_DEFERRED_HOLD",
        "FOLLOWER_CONTACT_PRELOAD_TRIBOLOGY_QUALIFICATION_HOLD",
        "M3_FASTENER_DEFINITION_AND_LOCAL_ALLOWABLE_HOLD",
        "INSTALLED_BUNDLE_RESISTANCE_TORQUE_HOLD_UNKNOWN_TORSION",
        "ANTI_ROTATION_KEY_AND_INTERSTAGE_RETENTION_QUALIFICATION_HOLD",
        "LAUNCH_AND_SPACE_ENVIRONMENT_QUALIFICATION_HOLD"
    ],
}
