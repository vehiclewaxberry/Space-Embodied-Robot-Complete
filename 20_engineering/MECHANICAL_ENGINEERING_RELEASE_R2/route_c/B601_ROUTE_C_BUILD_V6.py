...
OUT_FCSTD = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_GUIDED_DRESS_PACK_V6.FCStd")
OUT_STEP = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_GUIDED_DRESS_PACK_V6.step")
OUT_CENTERLINE = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_HARNESS_CENTERLINE_V6.json")
OUT_CLAMPS = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_CLAMP_AND_GUIDE_REGISTER_V6.csv")
OUT_MASS = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_MASS_DELTA_BY_LINK_CANDIDATES_V6.json")
OUT_RECEIPT = os.path.join(SCRIPT_DIR, "B601_ROUTE_C_BUILD_RECEIPT_V6.json")
...
# FreeCAD build
# ==========================================================================
doc = App.newDocument("B601_ROUTE_C_GUIDED_DRESS_PACK_V6")
part_registry = []
part_objects = {}
receipt_parts = []
...
mass_delta_doc = {
    "schema": "B601_ROUTE_C_MASS_DELTA_BY_LINK_CANDIDATES_V6",
...
tot_cap = 0.0
centerline_doc = {
    "schema": "B601_ROUTE_C_HARNESS_CENTERLINE_V6",
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
    "frame_convention": {
...
receipt = {
    "schema": "B601_ROUTE_C_BUILD_RECEIPT_V6",
    "generated_utc": "DETERMINISTIC_REPLAY_NO_WALLCLOCK",
