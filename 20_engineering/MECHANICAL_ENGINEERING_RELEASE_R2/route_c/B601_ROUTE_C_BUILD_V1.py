...
J2_C = (15.0, YC, 85.0)
j2_t1_xz, j2_start_ang = tangent_point_from_external((J2_C[0], J2_C[2]), 50.0, (P_J1OUT[0], P_J1OUT[2]), -1)
T1_J2 = circle_point(J2_C, (1, 0, 0), (0, 0, 1), 50.0, j2_start_ang)
j2_sweep = -250.0
j2_end_ang = j2_start_ang + j2_sweep
j2_end = circle_point(J2_C, (1, 0, 0), (0, 0, 1), 50.0, j2_end_ang)
...
j3_end = circle_point(J3_C, (1, 0, 0), (0, 0, 1), 63.0, j3_end_ang)
...
j4_end = circle_point(J4_C, (1, 0, 0), (0, 0, 1), 50.0, j4_end_ang)
...
j5_t1_xy, j5_start_ang = tangent_point_from_external((J5_C[0], J5_C[1]), 50.0, (K2[0], K2[1]), -1)
T1_J5 = (j5_t1_xy[0], j5_t1_xy[1], 210.0)
j5_sweep = -185.0
j5_end_ang = j5_start_ang + j5_sweep
j5_end = circle_point(J5_C, (1, 0, 0), (0, 1, 0), 50.0, j5_end_ang)
j5_exit_tan = tangent_dir_circle((1, 0, 0), (0, 1, 0), j5_end_ang, -1)
W1 = v_add(j5_end, v_mul(j5_exit_tan, 50.0))
W2 = (93.11, 89.04, 227.3)

# J6 helix: axis +x through (170, 0, 191.7), R50, pitch 20, start 180 deg, sweep +630
J6_ORIGIN = (170.0, 0.0, 191.7)
j6_pitch = 20.0
j6_start_ang = 180.0
j6_sweep = 630.0
j6_end_ang = j6_start_ang + j6_sweep
H0 = circle_point(J6_ORIGIN, (0, 1, 0), (0, 0, 1), 50.0, j6_start_ang)
j6_entry_tan = helix_tangent((1, 0, 0), (0, 1, 0), (0, 0, 1), 50.0, j6_pitch, j6_start_ang, +1)
A6 = v_sub(H0, v_mul(j6_entry_tan, 65.0))
j6_end = circle_point(J6_ORIGIN, (0, 1, 0), (0, 0, 1), 50.0, j6_end_ang)
j6_end = v_add(j6_end, v_mul((1, 0, 0), j6_pitch * math.radians(j6_sweep) / (2.0*math.pi)))
j6_exit_tan = helix_tangent((1, 0, 0), (0, 1, 0), (0, 0, 1), 50.0, j6_pitch, j6_end_ang, +1)
...
SEGMENTS = [
    {
        ...
        "sections": [("poly", [HN00, HN01, HN02, C1, C2, C2B, JV, KP, T1_COIL],
                      [0.0, 0.0, 50.0, 50.0, 50.0, 50.0, 50.0])],
    ...
    },
    {
        ...
        "sections": [
            ...
            ("poly", [j1_end, P_J1OUT, T1_J2], [50.0]),
        ],
    ...
    },
    {
        ...
        "sections": [
            ("arc", (J2_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 50.0, j2_start_ang, j2_sweep)),
            ("poly", [j2_end, M2, (-208.0, YC, 145.0), (-255.0, YC, 145.0)], [50.0, 0.0, 0.0]),
        ],
        "take_up_required_mm": 50.0*3.14,
        "take_up_capacity_mm": 50.0*math.radians(abs(j2_sweep)),
    ...
    },
    {
        ...
        "sections": [
            ("arc", (J3_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 63.0, j3_start_ang, j3_sweep)),
            ("poly", [j3_end, M3, F4, T1_J4], [50.0, 50.0, 0.0]),
        ],
        "take_up_required_mm": 63.0*3.14,
    ...
    },
    {
        ...
        "sections": [
            ("arc", (J4_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 50.0, j4_start_ang, j4_sweep)),
            ("poly", [j4_end, M4, K2, T1_J5], [50.0, 50.0, 50.0]),
        ],
        "take_up_required_mm": 50.0*3.44,
        "take_up_capacity_mm": 50.0*math.radians(abs(j4_sweep)),
    ...
    },
    {
        ...
        "sections": [
            ("arc", (J5_C, (0, 0, 1), (1, 0, 0), (0, 1, 0), 50.0, j5_start_ang, j5_sweep)),
            ("poly", [j5_end, W1, W2, A6, H0], [50.0, 50.0, 50.0]),
        ],
        "take_up_required_mm": 50.0*3.14,
        "take_up_capacity_mm": 50.0*math.radians(abs(j5_sweep)),
    ...
    },
    {
        ...
        "sections": [
            ("helix", (J6_ORIGIN, (1, 0, 0), (0, 1, 0), (0, 0, 1), 50.0, j6_pitch, j6_start_ang, j6_sweep)),
            ("poly", [j6_end, STUB_END, PLATE], [50.0]),
        ],
        "take_up_required_mm": 50.0*6.28,
        "take_up_capacity_mm": 50.0*math.radians(abs(j6_sweep))*1.002,
...
# FreeCAD build
# ==========================================================================
doc = App.newDocument("B601_ROUTE_C_GUIDED_DRESS_PACK_V1")
part_registry = []
part_objects = {}
receipt_parts = []
...
clamp_saddle("RC-CLP-BUS-RISER", C2, v_norm(v_sub(C2B, C2)), "aluminum", "base_link",
             "CF-BUS-03 riser clamp, bracket arm to collar ring at HN-04 station")
oriented_box("RC-BRK-J1-RISER", (14.56, -77.98, 88.0), (8.0, 12.0, 76.0), (0, 0, 1), (0, 1, 0),
...
guide_tube("RC-GDE-J2-MANDREL", J2_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 50.0, j2_start_ang, j2_sweep, 6.0,
           "aluminum", "link1", "J2 U-loop guide mandrel R50 270 deg", "guide_mandrel")
guide_tube("RC-GDE-J2-MANDREL-LINER", J2_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 50.0, j2_start_ang, j2_sweep, 7.5,
...
channel_section("RC-CHN-L2", M2, (-208.0, YC, 145.0), 12.0, 12.0, "aluminum", "link2",
                "link2 fixed channel incl. carrier straight section")
clamp_saddle("RC-CLP-L2-01", (-80.0, YC, 145.0), (-1, 0, 0), "aluminum", "link2", "CF-L2-01 fixed clamp")
clamp_saddle("RC-CLP-L2-02", (-208.0, YC, 145.0), (-1, 0, 0), "aluminum", "link2", "CF-L2-02 fixed clamp at channel end")
...
oriented_box("RC-CAR-J3-CARRIAGE", (-140.0, YC, 145.0), (36.0, 24.0, 22.0), (1, 0, 0), (0, 1, 0), "aluminum", "link2",
             "J3 moving carriage (nominal mid-travel x=-140), bore for bundle, E2.10-class guide channel", kind="carrier")
clamp_saddle("RC-CLP-J3-MOV", (-140.0, YC, 145.0), (-1, 0, 0), "polymer", "link2", "CM-J3-M moving clamp on carriage")
for i in range(6):
    box_at("RC-CHN-E210-LINK-%02d" % i, (-95.0 - i*20.0, YC, 145.0), (18.0, 16.0, 10.0), "polymer", "link2",
           "igus E2.10 e-chain link %d/6 (pitch 20, inner 10x16)" % (i+1))

# J3 saddle + liner
guide_tube("RC-GDE-J3-SADDLE", J3_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 63.0, j3_start_ang, j3_sweep, 7.0,
           "aluminum", "link2", "J3 guide saddle R63 200 deg", "guide_saddle")
guide_tube("RC-GDE-J3-SADDLE-LINER", J3_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 63.0, j3_start_ang, j3_sweep, 8.6,
...
guide_tube("RC-GDE-J4-MANDREL", J4_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 50.0, j4_start_ang, j4_sweep, 6.0,
           "aluminum", "link3", "J4 loop guide mandrel R50 315 deg", "guide_mandrel")
guide_tube("RC-GDE-J4-MANDREL-LINER", J4_C, (0, 1, 0), (1, 0, 0), (0, 0, 1), 50.0, j4_start_ang, j4_sweep, 7.5,
...
guide_tube("RC-GDE-J5-WRAP", J5_C, (0, 0, 1), (1, 0, 0), (0, 1, 0), 50.0, j5_start_ang, j5_sweep, 6.0,
           "aluminum", "link5", "J5 wrist wrap mandrel R50 185 deg", "guide_mandrel")
guide_tube("RC-GDE-J5-WRAP-LINER", J5_C, (0, 0, 1), (1, 0, 0), (0, 1, 0), 50.0, j5_start_ang, j5_sweep, 7.5,
...
for idx, ang in enumerate([180.0, 360.0, 540.0, 720.0]):
    ...
    ring("RC-GDE-J6-RING-%d" % idx, c, (1, 0, 0), 58.0, 52.0, 4.0, "polymer", "link6",
         "J6 helix guide ring %d at wrap angle %.0f deg" % (idx, ang))
box_at("RC-BRK-J6-GUIDE-A", (180.0, 0.0, 250.0), (8.0, 30.0, 6.0), "aluminum", "link6", "J6 guide ring support arm A")
box_at("RC-BRK-J6-GUIDE-B", (200.0, 0.0, 250.0), (8.0, 30.0, 6.0), "aluminum", "link6", "J6 guide ring support arm B")
...
CLAMPS = [
    ...
    ("CF-BUS-03", "base_link", C2, "FIXED", "2xM3 on bracket arm",
    ...
    ("CF-L2-01", "link2", (-80.0, YC, 145.0), "FIXED", "2xM3 on RC-CHN-L2", "link2 channel fixed clamp"),
    ("CM-J3-M", "link2", (-140.0, YC, 145.0), "MOVING_CARRIER", "carriage RC-CAR-J3-CARRIAGE",
     "J3 carrier moving clamp, travel x -85..-195 (link2 frame)"),
    ("CF-L2-02", "link2", (-208.0, YC, 145.0), "FIXED", "2xM3 on RC-CHN-L2", "link2 channel end clamp"),
    ("CG-J3-S", "link2", (-255.0, YC, 145.0), "GUIDE_SADDLE", "4xM3 saddle bracket", "J3 guide saddle entry tangent"),
...
mass_delta_doc = {
    ...
    "generated_utc": "2026-08-25T10:02:34Z",
...
tot_cap = 0.0
centerline_doc = {
    "schema": "B601_ROUTE_C_HARNESS_CENTERLINE_V1",
    "generated_utc": "2026-08-25T10:02:34Z",
    "frame_convention": {
...
receipt = {
    "schema": "B601_ROUTE_C_BUILD_RECEIPT_V1",
    "generated_utc": "2026-08-25T10:02:34Z",
