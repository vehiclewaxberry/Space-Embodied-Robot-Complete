...
STEP = os.path.join(AUDIT, "03_native_cad",
                    "F3R1_V2_MATED_STOWED.step")
RAW = os.path.join(AUDIT, "11_screenshots", "RAW")
OUT = os.path.join(AUDIT, "11_screenshots", "F3R1_G1_RENDER_INDEX.json")
W, H = 1920, 1080
...
for sid, fn in [("G1_S01_MATED_ISO", "viewAxonometric"),
                ("G1_S02_MATED_TOP", "viewTop"),
                ("G1_S03_MATED_SIDE", "viewRight"),
                ("G1_S04_MATED_FRONT", "viewFront")]:
    getattr(v, fn)()
    FreeCADGui.updateGui()
