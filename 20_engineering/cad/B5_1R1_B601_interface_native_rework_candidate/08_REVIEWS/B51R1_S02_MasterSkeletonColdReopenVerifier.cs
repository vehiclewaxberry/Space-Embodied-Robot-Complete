...
public static class B51R1S02MasterSkeletonColdReopenVerifier
{
        ...
        string expectedFinalLockSha256)
    {
        ...
        {
            {"schema", "B51R1_S02_MASTER_SKELETON_COLD_REOPEN_RECEIPT_V1"},
            {"session_id", "S02"},
        ...
        try
        {
            ...
            receipt["status"] = "S02_PASS_MASTER_SKELETON_COLD_REOPEN";
        ...
        {
            receipt["status"] = "S02_FAIL_CLOSED";
