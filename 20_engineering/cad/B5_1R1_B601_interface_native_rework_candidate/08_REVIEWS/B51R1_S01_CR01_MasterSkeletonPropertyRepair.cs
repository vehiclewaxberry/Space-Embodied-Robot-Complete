...
public static class B51R1S01CR01MasterSkeletonPropertyRepair
{
    ...
    private const int CustomPropertyReplaceValue = 2;
        ...
        Dictionary<string, string> expectedProperties)
    {
        ...
        try
        {
            ...
            foreach (string name in RepairPropertyNames)
            {
                ...
                evidence["overwrite_option"] = CustomPropertyReplaceValue;
