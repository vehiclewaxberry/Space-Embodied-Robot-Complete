...
$admission = Join-Path $sessionRoot 'B51R1_S01_CR01_ADMISSION_ADDENDUM_V2.json'
$inputLock = Join-Path $sessionRoot 'B51R1_S01_CR01_INPUT_LOCK_SUPPLEMENT_V4.json'
...
$toolDll = Join-Path $PSScriptRoot 'B51R1_S01_CR01_MasterSkeletonPropertyRepair_V3.dll'
...
$expectedToolDll = '7E182DA01BBB85E8C7A29B1B1DF798FBE41186880505B339364AF226B387C0FB'
...
try {
    ...
    $result = [B51R1S01CR01MasterSkeletonPropertyRepairV3]::Run(
        $source,
        $work,
        $target,
        $stageA,
