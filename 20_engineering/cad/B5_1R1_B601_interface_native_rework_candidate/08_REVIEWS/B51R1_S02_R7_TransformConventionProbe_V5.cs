...
public static class B51R1S02R7TransformConventionProbeV5
{
        ...
        string expectedStageASha256)
    {
        ...
        {
            {"schema", "B51R1_S02_R7_TRANSFORM_CONVENTION_PROBE_V5"},
            {"session_id", "S02_R7"},
            {"generated_at_utc", DateTime.UtcNow.ToString("o")},
            {"status", "S02_R7_FAIL_CLOSED_NOT_STARTED"},
        ...
        {
            receipt["status"] = "S02_R7_FAIL_CLOSED";
