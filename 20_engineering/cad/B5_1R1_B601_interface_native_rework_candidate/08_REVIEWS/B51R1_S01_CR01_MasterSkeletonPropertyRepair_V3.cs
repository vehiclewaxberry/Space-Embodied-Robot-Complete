...
public static class B51R1S01CR01MasterSkeletonPropertyRepairV3
{
            ...
            foreach (object rawConfiguration in rawConfigurations)
            {
                ...
                try
                {
                    ...
                    Require(manager != null,
                        "Configuration-level CustomPropertyManager is unavailable: " +
                        configurationName);
        ...
        string expectedFinalInputLockSha256)
    {
        ...
        {
            {"schema", "B51R1_S01_CR01_MASTER_SKELETON_PROPERTY_REPAIR_RECEIPT_V1"},
            {"session_id", "S01_CR01"},
        ...
        try
        {
            ...
            receipt["configuration_property_prestate"] =
                VerifyNoConfigurationLevelRepairProperties(model, "PRE_REPAIR");
            ...
            receipt["configuration_property_post_add"] =
                VerifyNoConfigurationLevelRepairProperties(model, "POST_ADD_PRE_SAVE");
            ...
            receipt["revision_configuration_property_scope"] =
                VerifyNoConfigurationLevelRepairProperties(model, "REVISION_REOPEN");
            ...
            receipt["revision_configuration_property_scope_after_rebuild"] =
                VerifyNoConfigurationLevelRepairProperties(
                    model, "REVISION_REOPEN_AFTER_REBUILD");
            ...
            receipt["status"] = "S01_CR01_PASS_APPEND_ONLY_PROPERTY_REPAIR_REVISION_CREATED";
        ...
        {
            receipt["status"] = "S01_CR01_FAIL_CLOSED";
