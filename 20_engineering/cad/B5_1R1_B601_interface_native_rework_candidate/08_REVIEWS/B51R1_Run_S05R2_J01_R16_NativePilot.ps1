...
$sessionRoot = Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R16'
...
$toolSource = Join-Path $PSScriptRoot 'B51R1_S05R2_J01_R16_NativePilotTool.cs'
$toolDll = Join-Path $PSScriptRoot 'B51R1_S05R2_J01_R16_NativePilotTool.dll'
$toolRunner = Join-Path $PSScriptRoot 'B51R1_Run_S05R2_J01_R16_NativePilot.ps1'
$toolSourceBytes = 136319
$toolSourceSha256 = '0DF51DBE6733FB3564B87973F6A26C55D5995D184AB3D6AF8443A381F731FEAE'
$toolDllBytes = 85504
$toolDllSha256 = '5CA8CADFEBE471A41F77FFB1F63748E9C44A6E207E47D15B123D90C71F51C3A3'
...
$r16StaticRelease = Join-Path $PSScriptRoot 'B51R1_S05R2_J01_R16_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1.json'
$r16CreateActivation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R25A_POOL_A_A08R2_J01_R16_SELECTION_LEDGER_NATIVE_1R_PILOT_CREATE_ACTIVATION.json'
$r16ColdActivation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R26A_POOL_A_A08R2_J01_R16_SELECTION_LEDGER_NATIVE_1R_PILOT_COLD_VERIFY_ACTIVATION.json'
...
$r14FailureReceipt = Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_CREATE_RECEIPT.json'
$r14FailureReceiptBytes = 102459
$r14FailureReceiptSha256 = '3E4BA1AD5D099C6C65683D1738ECA0329897CD916534746317B8D6ABA2C061A4'
$r14FailureInputLock = Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_CREATE_INPUT_LOCK.json'
$r14FailureInputLockBytes = 60726
$r14FailureInputLockSha256 = '7DEAF920D237EC0B2898858AE70E02AD2C29E4501E83D1D4C2B5AC5354B28E07'
$r14FailureReadiness = Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_CREATE_READINESS_RECEIPT.json'
$r14FailureReadinessBytes = 470
$r14FailureReadinessSha256 = 'B71AD5A5B941C2843CBBCB31C51890273A3E55E76C6BB303699FDBF3A1FC285D'
$r14FailureProgress = Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_CREATE_PROGRESS.log'
$r14FailureProgressBytes = 148
$r14FailureProgressSha256 = '782F095F6642C930994A531765BB9FEA52C9361D7763F209899B10A3900D22EB'
$r14PartialJ00Assembly = Join-Path $root '03_CAD\20_NATIVE_ASSEMBLY\PILOT\CHECKPOINTS\B51R1_CARRIER_J00_ROOT_PILOT_R14.SLDASM'
$r14PartialJ00AssemblyBytes = 44258
$r14PartialJ00AssemblySha256 = '56E20CC6A2115C2E541D68D49A0CF9D32B8AF21DF3BE6428859BA8D27CA73C6C'
$r14PredecessorStaticRelease = Join-Path $root '08_REVIEWS\B51R1_S05R2_J01_R14_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1.json'
$r14PredecessorStaticReleaseBytes = 8278
$r14PredecessorStaticReleaseSha256 = 'DA1EDD8FA62E7969AA19C1FE0866F04072F6148431CFFF5100E210626EE4AA69'
$r14PredecessorCreateActivation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R21A_POOL_A_A08R2_J01_R14_SELECTION_LEDGER_NATIVE_1R_PILOT_CREATE_ACTIVATION.json'
$r14PredecessorCreateActivationBytes = 4989
$r14PredecessorCreateActivationSha256 = '355122826E10FF45357BB70B0D0DEBDC2A062B14A1C0DEC168A1CF28D1CD6628'
$r14Source = Join-Path $root '08_REVIEWS\B51R1_S05R2_J01_R14_NativePilotTool.cs'
$r14SourceBytes = 133772
$r14SourceSha256 = '2834458C2A77F30A255926C8C118B5DCD7E3080FC749D3601590D001064B0C56'
$r14Runner = Join-Path $root '08_REVIEWS\B51R1_Run_S05R2_J01_R14_NativePilot.ps1'
$r14RunnerBytes = 167498
$r14RunnerSha256 = '993B1433221FC2C4C6FB29CD6F2E65EB26BBFE3147DCA89CB9E2A372585CD4E9'
$r14Binary = Join-Path $root '08_REVIEWS\B51R1_S05R2_J01_R14_NativePilotTool.dll'
$r14BinaryBytes = 83968
$r14BinarySha256 = '37E0DB2B4E954D896BF9903A881126424940C9CF65959C0AB5AB44FD4B69D0D6'
$r14AbsentSuccessOutputs = @(
    (Join-Path $root '03_CAD\20_NATIVE_ASSEMBLY\PILOT\B51R1_CARRIER_J01_R14_NATIVE_PILOT.SLDASM'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_J00_BASELINE_CHECKPOINT.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_CREATE_GATE.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_COLD_REOPEN_RECEIPT.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_COLD_REOPEN_PROGRESS.log'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R14\B51R1_S05R2_J01_R14_NATIVE_1R_GATE.json'),
    (Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R22A_POOL_A_A08R2_J01_R14_SELECTION_LEDGER_NATIVE_1R_PILOT_COLD_VERIFY_ACTIVATION.json')
)
$r15PrelaunchIncident = Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_PRELAUNCH_FAIL_CLOSED_INCIDENT.json'
$r15PrelaunchIncidentBytes = 3144
$r15PrelaunchIncidentSha256 = '9D11ADC0A926F954314A9302786F362FDC2D6149926AC9CB3694EC35334B1B9E'
$r15PrelaunchStartProcessCallCount = 0
$r15Source = Join-Path $root '08_REVIEWS\B51R1_S05R2_J01_R15_NativePilotTool.cs'
$r15SourceBytes = 136319
$r15SourceSha256 = 'B49A34BA14172EC596301DFA6683AD7DC81765B01692A0D6225B7FE3F643764C'
$r15Runner = Join-Path $root '08_REVIEWS\B51R1_Run_S05R2_J01_R15_NativePilot.ps1'
$r15RunnerBytes = 184414
$r15RunnerSha256 = '82C0565E4074E870CA876E75C5028B7FB30CF4A791556BF1585DC405FCD7898C'
$r15Binary = Join-Path $root '08_REVIEWS\B51R1_S05R2_J01_R15_NativePilotTool.dll'
$r15BinaryBytes = 85504
$r15BinarySha256 = '834EA37333873840221853FC8F98FB37FD73606C737648BC262D63A0478E7639'
$r15PredecessorStaticRelease = Join-Path $root '08_REVIEWS\B51R1_S05R2_J01_R15_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1.json'
$r15PredecessorStaticReleaseBytes = 8972
$r15PredecessorStaticReleaseSha256 = 'F7D2D94CB6E9E9636A2F73C5BCFA2A9DF7B925A454AA203061BD048F52A6714F'
$r15PredecessorCreateActivation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R23A_POOL_A_A08R2_J01_R15_SELECTION_LEDGER_NATIVE_1R_PILOT_CREATE_ACTIVATION.json'
$r15PredecessorCreateActivationBytes = 5230
$r15PredecessorCreateActivationSha256 = '4C4D38F58D5F4BB042462D611845584F415B6DF6C5C775F414CCBDEBF13767BC'
$r15AbsentSuccessOutputs = @(
    (Join-Path $root '03_CAD\20_NATIVE_ASSEMBLY\PILOT\B51R1_CARRIER_J01_R15_NATIVE_PILOT.SLDASM'),
    (Join-Path $root '03_CAD\20_NATIVE_ASSEMBLY\PILOT\CHECKPOINTS\B51R1_CARRIER_J00_ROOT_PILOT_R15.SLDASM'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_CREATE_READINESS_RECEIPT.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_CREATE_INPUT_LOCK.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_J00_BASELINE_CHECKPOINT.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_CREATE_RECEIPT.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_CREATE_PROGRESS.log'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_CREATE_GATE.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_COLD_REOPEN_RECEIPT.json'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_COLD_REOPEN_PROGRESS.log'),
    (Join-Path $root '07_VERIFICATION\AUTONOMOUS\S05R2_J01_R15\B51R1_S05R2_J01_R15_NATIVE_1R_GATE.json'),
    (Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R24A_POOL_A_A08R2_J01_R15_SELECTION_LEDGER_NATIVE_1R_PILOT_COLD_VERIFY_ACTIVATION.json')
)
...
$j00Assembly = Join-Path $checkpointDir 'B51R1_CARRIER_J00_ROOT_PILOT_R16.SLDASM'
$pilotAssembly = Join-Path $pilotDir 'B51R1_CARRIER_J01_R16_NATIVE_PILOT.SLDASM'
$j00Checkpoint = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_J00_BASELINE_CHECKPOINT.json'
$createReceipt = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_CREATE_RECEIPT.json'
$createProgress = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_CREATE_PROGRESS.log'
$createGate = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_CREATE_GATE.json'
$coldReceipt = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_COLD_REOPEN_RECEIPT.json'
$coldProgress = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_COLD_REOPEN_PROGRESS.log'
$finalGate = Join-Path $sessionRoot 'B51R1_S05R2_J01_R16_NATIVE_1R_GATE.json'
...
function Get-ModeActivation([string]$RequestedMode) {
    $activationPath = if ($RequestedMode -eq 'Create') { $r16CreateActivation } else { $r16ColdActivation }
    if (-not (Test-Path -LiteralPath $activationPath -PathType Leaf)) {
        throw "J01 R16 $RequestedMode has no independent activation: $activationPath"
    }
    ...
    $expectedSchema = if ($RequestedMode -eq 'Create') {
        'B51R1_AUTONOMOUS_SESSION_PLAN_V22R25A_POOL_A_A08R2_J01_R16_SELECTION_LEDGER_NATIVE_1R_PILOT_CREATE_ACTIVATION_V1'
    } else {
        'B51R1_AUTONOMOUS_SESSION_PLAN_V22R26A_POOL_A_A08R2_J01_R16_SELECTION_LEDGER_NATIVE_1R_PILOT_COLD_VERIFY_ACTIVATION_V1'
    }
    $expectedStatus = if ($RequestedMode -eq 'Create') {
        'POOL_A_A08R2_J01_R16_SELECTION_LEDGER_NATIVE_1R_PILOT_CREATE_ACTIVATED'
    } else {
        'POOL_A_A08R2_J01_R16_SELECTION_LEDGER_NATIVE_1R_PILOT_COLD_VERIFY_ACTIVATED'
    }
    ...
    if ($activation.schema -ne $expectedSchema -or $activation.status -ne $expectedStatus -or
        ...
        [IO.Path]::GetFullPath([string]$activation.static_release.path) -ne [IO.Path]::GetFullPath($r16StaticRelease)) {
        throw "J01 R16 $RequestedMode activation contract mismatch"
    }
    Assert-File $r16StaticRelease ([long]$activation.static_release.bytes) ([string]$activation.static_release.sha256) 'J01 R16 static release bound by activation'
    $release = Get-Content -Raw -Encoding UTF8 -LiteralPath $r16StaticRelease | ConvertFrom-Json
    if ($release.schema -ne 'B51R1_S05R2_J01_R16_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1' -or
        $release.status -ne 'STATIC_RELEASE_PASS' -or $release.gate_pass -ne $true -or
        $release.runtime_executed -ne $false -or [long]$release.recovery_prerequisite_count -ne 16 -or
        ...
        [long]$release.runner.r15_prelaunch_closure_artifact_count -ne 6 -or
        [long]$release.runner.create_locked_item_count -ne 93 -or
        [long]$release.runner.cold_verify_locked_item_count -ne 96 -or
        ...
        throw 'J01 R16 static release semantic contract mismatch'
    }
    if ([IO.Path]::GetFullPath([string]$activation.tool.source.path) -ne [IO.Path]::GetFullPath($toolSource) -or
        ...
        throw "J01 R16 $RequestedMode activation tool binding mismatch"
    }
    if ($RequestedMode -eq 'Create') {
        if ($activation.create_authorized -ne $true -or $activation.cold_verify_authorized -ne $false -or
            [string]$activation.required_limit_angle_recovery -ne
                'CLEAR_SELECTION_ASSIGN_ENTITIES_ONLY_KEEP_REFERENCE_NULL_AND_TREAT_PRECREATE_ENTITIES_GETTER_AS_DIAGNOSTIC_ONLY' -or
            [long]$activation.required_counts.recovery_prerequisites -ne 16 -or
            [long]$activation.required_counts.predecessor_transaction_closure_artifacts -ne 6 -or
            [long]$activation.required_counts.create_locked_items -ne 93 -or
            [IO.Path]::GetFullPath([string]$activation.predecessor_incident.path) -ne [IO.Path]::GetFullPath($r15PrelaunchIncident) -or
            [long]$activation.predecessor_incident.bytes -ne $r15PrelaunchIncidentBytes -or
            [string]$activation.predecessor_incident.sha256 -ne $r15PrelaunchIncidentSha256 -or
            [string]$activation.predecessor_incident.required_status -ne 'S05R2_J01_R15_PRELAUNCH_FAIL_CLOSED' -or
            [long]$activation.predecessor_incident.solidworks_start_process_call_count -ne 0) {
            throw 'J01 R16 Create activation scope/predecessor binding mismatch'
        }
    } else {
        if ($activation.create_authorized -ne $false -or $activation.cold_verify_authorized -ne $true -or
            ...
            throw 'J01 R16 ColdVerify activation scope/path binding mismatch'
        }
        Assert-File $createGate ([long]$activation.create_gate.bytes) ([string]$activation.create_gate.sha256) 'J01 R16 Cold activation Create Gate'
        Assert-File $createReceipt ([long]$activation.create_receipt.bytes) ([string]$activation.create_receipt.sha256) 'J01 R16 Cold activation Create receipt'
        Assert-File $pilotAssembly ([long]$activation.pilot_output.bytes) ([string]$activation.pilot_output.sha256) 'J01 R16 Cold activation pilot output'
    }
    if ($activation.formal_s05_authorized -ne $false -or $activation.t005_authorized -ne $false) {
        throw "J01 R16 $RequestedMode activation exceeds Pilot scope"
    }
    return [ordered]@{
        id="J01_R16_$($RequestedMode.ToUpperInvariant())_ACTIVATION"
...
function Get-RecoveryPrerequisites {
    Assert-File $hp01DirectReceipt $hp01DirectReceiptBytes $hp01DirectReceiptSha256 'J01 R16 direct-open health receipt'
    ...
    if ($direct.schema -ne 'B51R1_S05R2_R1_DRIVER_READY_COLD_REOPEN_V3' -or
        ...
        throw 'J01 R16 direct-open health receipt contract mismatch'
    }
    $directParts = @($direct.parts)
    if ($directParts.Count -ne 2 -or @($directParts.link | Select-Object -Unique).Count -ne 2) {
        throw 'J01 R16 direct-open health receipt does not bind two unique parts'
    }
    foreach ($link in @('base_link','link1')) {
        $part = @($directParts | Where-Object { $_.link -eq $link })
        if ($part.Count -ne 1) { throw "J01 R16 direct-open part is not unique: $link" }
        $expectedPath = if ($link -eq 'base_link') { $baseCarrier } else { $link1Carrier }
        $expectedBytes = if ($link -eq 'base_link') { $baseCarrierBytes } else { $link1CarrierBytes }
        $expectedSha = if ($link -eq 'base_link') { $baseCarrierSha256 } else { $link1CarrierSha256 }
        if ([IO.Path]::GetFullPath([string]$part[0].path) -ne [IO.Path]::GetFullPath($expectedPath) -or
            ...
            throw "J01 R16 direct-open health binding mismatch: $link"
        }
    }
    ...
    # closure before permitting this R16 Create attempt.
    ...
    # Freeze its receipt plus the remaining nine transaction artifacts before R16.
    ...
    # R14 proved that its pre-Create EntitiesToMate getter is not a managed array.
    # Freeze the receipt plus its remaining nine transaction artifacts before R16.
    Assert-File $r14FailureReceipt $r14FailureReceiptBytes $r14FailureReceiptSha256 'J01 R14 failure receipt'
    Assert-File $r14FailureInputLock $r14FailureInputLockBytes $r14FailureInputLockSha256 'J01 R14 failure input lock'
    Assert-File $r14FailureReadiness $r14FailureReadinessBytes $r14FailureReadinessSha256 'J01 R14 failure readiness'
    Assert-File $r14FailureProgress $r14FailureProgressBytes $r14FailureProgressSha256 'J01 R14 failure progress'
    Assert-File $r14PartialJ00Assembly $r14PartialJ00AssemblyBytes $r14PartialJ00AssemblySha256 'J01 R14 partial J00 assembly'
    Assert-File $r14PredecessorStaticRelease $r14PredecessorStaticReleaseBytes $r14PredecessorStaticReleaseSha256 'J01 R14 static release predecessor'
    Assert-File $r14PredecessorCreateActivation $r14PredecessorCreateActivationBytes $r14PredecessorCreateActivationSha256 'J01 R14 Create activation predecessor'
    Assert-File $r14Source $r14SourceBytes $r14SourceSha256 'J01 R14 source predecessor'
    Assert-File $r14Runner $r14RunnerBytes $r14RunnerSha256 'J01 R14 runner predecessor'
    Assert-File $r14Binary $r14BinaryBytes $r14BinarySha256 'J01 R14 binary predecessor'
    foreach ($path in $r14AbsentSuccessOutputs) {
        if (Test-Path -LiteralPath $path) { throw "J01 R14 unexpectedly produced a success-state output: $path" }
    }
    $r14Failed = Get-Content -Raw -Encoding UTF8 -LiteralPath $r14FailureReceipt | ConvertFrom-Json
    if ($r14Failed.schema -ne 'B51R1_S05R2_J01_R14_NATIVE_PILOT_CREATE_V1' -or
        $r14Failed.status -ne 'S05R2_J01_R14_NATIVE_1R_PILOT_CREATE_FAIL_CLOSED' -or
        $r14Failed.gate_pass -isnot [bool] -or $r14Failed.gate_pass -ne $false -or
        [long]$r14Failed.expected_process_id -ne 52552 -or
        [string]$r14Failed.exception_type -ne 'System.InvalidOperationException' -or
        [string]$r14Failed.exception -notmatch 'J01_LIMIT_ANGLE_DRIVER pre-CreateMate EntitiesToMate getter is not an array' -or
        [string]$r14Failed.exception -notmatch '\.ObjectArray\(' -or
        [long]$r14Failed.save_as_call_count -ne 1 -or
        [long]$r14Failed.create_mate_data_call_count -ne 5 -or
        [long]$r14Failed.create_mate_call_count -ne 4 -or
        [long]$r14Failed.mate_preselection_call_count -ne 13 -or
        [long]$r14Failed.document_count_before_new_assembly -ne 2 -or
        [long]$r14Failed.document_count_after_new_assembly -ne 3 -or
        [string]$r14Failed.base_hash_after_failure -ne $baseCarrierSha256 -or
        [string]$r14Failed.link1_hash_after_failure -ne $link1CarrierSha256 -or
        @($r14Failed.mate_api_attempts).Count -ne 5 -or
        @($r14Failed.mate_preselection_attempts).Count -ne 13) {
        throw 'J01 R14 pre-Create EntitiesToMate getter failure boundary mismatch'
    }
    foreach ($field in @('save3_call_count','add_mate5_call_count','transform2_call_count',
        'set_transform_and_solve_call_count','move_component_call_count')) {
        if ([long]$r14Failed.$field -ne 0) { throw "J01 R14 failure crossed a prohibited action boundary at $field" }
    }
    $r14Attempts = @($r14Failed.mate_api_attempts)
    $r14AngleAttempt = $r14Attempts[4]
    $r14AngleSelections = @($r14AngleAttempt.entity_selections)
    $r14SuccessfulAttemptCount = 0
    foreach ($index in 0..3) {
        $completedAttempt = $r14Attempts[$index]
        foreach ($optionalField in @('create_mate_call_index','feature_returned','create_mate_error_status')) {
            if ($null -eq $completedAttempt.PSObject.Properties[$optionalField]) {
                throw "J01 R14 completed mate attempt $index lacks optional result field $optionalField"
            }
        }
        if ([long]$completedAttempt.create_mate_call_index -ne ($index + 1) -or
            $completedAttempt.feature_returned -isnot [bool] -or $completedAttempt.feature_returned -ne $true -or
            [long]$completedAttempt.create_mate_error_status -ne 1) {
            throw "J01 R14 completed mate attempt $index is not a successful CreateMate result"
        }
        $r14SuccessfulAttemptCount++
    }
    if ($r14SuccessfulAttemptCount -ne 4 -or
        [string]$r14AngleAttempt.name -ne 'J01_LIMIT_ANGLE_DRIVER' -or
        [long]$r14AngleAttempt.selection_count_before_direct_property_contract_clear -ne 3 -or
        [long]$r14AngleAttempt.selection_count_after_direct_property_contract_clear -ne 0 -or
        [long]$r14AngleAttempt.preselection_count_before_create_mate_data -ne 0 -or
        [long]$r14AngleAttempt.create_mate_data_call_index -ne 5 -or
        $r14AngleAttempt.mate_data_returned -ne $true -or
        $r14AngleAttempt.direct_property_entities_assigned -ne $true -or
        $r14AngleAttempt.direct_property_reference_assigned -ne $false -or
        $null -ne $r14AngleAttempt.PSObject.Properties['create_mate_call_index'] -or
        $null -ne $r14AngleAttempt.PSObject.Properties['feature_returned'] -or
        $null -ne $r14AngleAttempt.PSObject.Properties['create_mate_error_status'] -or
        $r14AngleSelections.Count -ne 3 -or
        [long]$r14AngleSelections[0].mark -ne 1 -or [long]$r14AngleSelections[1].mark -ne 1 -or
        [long]$r14AngleSelections[2].mark -ne 67108864) {
        throw 'J01 R14 pre-Create EntitiesToMate getter ledger mismatch'
    }
    $r14Lock = Get-Content -Raw -Encoding UTF8 -LiteralPath $r14FailureInputLock | ConvertFrom-Json
    $r14Ready = Get-Content -Raw -Encoding UTF8 -LiteralPath $r14FailureReadiness | ConvertFrom-Json
    if ($r14Lock.schema -ne 'B51R1_S05R2_J01_R14_CREATE_INPUT_LOCK_V1' -or
        $r14Lock.status -ne 'PASS_S05R2_J01_R14_CREATE_INPUTS_HASH_LOCKED' -or $r14Lock.mode -ne 'Create' -or
        [long]$r14Lock.runtime_boundary.solidworks_process_id -ne 52552 -or
        [long]$r14Lock.runtime_boundary.launch_handle_process_id -ne 52552 -or
        $r14Lock.runtime_boundary.launch_handle_matches_sole_process -ne $true -or
        [long]$r14Lock.runtime_boundary.process_count -ne 1 -or
        [long]$r14Lock.runtime_boundary.document_count -ne 0 -or
        [long]$r14Lock.runtime_boundary.prelaunch_sldworks_process_count -ne 0 -or
        [long]$r14Lock.runtime_boundary.persistent_use_software_ogl_before -ne 0 -or
        [long]$r14Lock.runtime_boundary.persistent_use_software_ogl_after_launch -ne 0 -or
        @($r14Lock.recovery_prerequisites).Count -ne 14 -or
        @($r14Lock.locked_items).Count -ne 77 -or
        $r14Lock.transaction.formal_s05_output_allowed -ne $false -or
        $r14Lock.transaction.t005_authorized -ne $false) {
        throw 'J01 R14 failure input-lock boundary mismatch'
    }
    if ($r14Ready.schema -ne 'B51R1_SR03_EXISTING_SOLIDWORKS_PROBE_V1' -or
        $r14Ready.status -ne 'PASS_EXISTING_SINGLE_VISIBLE_RESPONSIVE_DOCUMENT_EMPTY_SESSION' -or
        [long]$r14Ready.expected_process_id -ne 52552 -or [long]$r14Ready.observed_process_id -ne 52552 -or
        $r14Ready.visible -ne $true -or $r14Ready.startup_process_completed -ne $true -or
        [long]$r14Ready.document_count -ne 0 -or $r14Ready.active_document_present -ne $false) {
        throw 'J01 R14 failure readiness receipt mismatch'
    }
    $r14ProgressLines = @((Get-Content -Raw -Encoding UTF8 -LiteralPath $r14FailureProgress).TrimEnd() -split '\r?\n')
    if ($r14ProgressLines.Count -ne 2 -or
        $r14ProgressLines[0] -notmatch '^J01_R14_CREATE_START ' -or
        $r14ProgressLines[1] -notmatch '^J01_R14_CREATE_FAIL J01_LIMIT_ANGLE_DRIVER pre-CreateMate EntitiesToMate getter is not an array$') {
        throw 'J01 R14 progress does not prove the pre-Create EntitiesToMate getter fail-closed boundary'
    }
    $r14Release = Get-Content -Raw -Encoding UTF8 -LiteralPath $r14PredecessorStaticRelease | ConvertFrom-Json
    $r14ActivationState = Get-Content -Raw -Encoding UTF8 -LiteralPath $r14PredecessorCreateActivation | ConvertFrom-Json
    if ($r14Release.schema -ne 'B51R1_S05R2_J01_R14_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1' -or
        $r14Release.status -ne 'STATIC_RELEASE_PASS' -or $r14Release.gate_pass -ne $true -or
        $r14Release.runtime_executed -ne $false -or [long]$r14Release.recovery_prerequisite_count -ne 14 -or
        [long]$r14Release.runner.r13_transaction_closure_artifact_count -ne 10 -or
        [long]$r14Release.runner.create_locked_item_count -ne 77 -or
        [long]$r14Release.runner.cold_verify_locked_item_count -ne 80 -or
        $r14Release.create_activation_authorized -ne $true -or
        $r14Release.cold_verify_activation_authorized -ne $false -or
        $r14ActivationState.activation_mode -ne 'CREATE_ONLY' -or
        [long]$r14ActivationState.required_counts.recovery_prerequisites -ne 14 -or
        [long]$r14ActivationState.required_counts.predecessor_transaction_closure_artifacts -ne 10 -or
        [long]$r14ActivationState.required_counts.create_locked_items -ne 77 -or
        $r14ActivationState.create_authorized -ne $true -or $r14ActivationState.cold_verify_authorized -ne $false -or
        $r14ActivationState.formal_s05_authorized -ne $false -or $r14ActivationState.t005_authorized -ne $false) {
        throw 'J01 R14 predecessor static release/Create activation contract mismatch'
    }

    # R15 failed during recovery validation before Start-Process because the R14 fifth
    # attempt legitimately omitted optional CreateMate result fields.
    Assert-File $r15PrelaunchIncident $r15PrelaunchIncidentBytes $r15PrelaunchIncidentSha256 'J01 R15 prelaunch incident'
    Assert-File $r15Source $r15SourceBytes $r15SourceSha256 'J01 R15 source predecessor'
    Assert-File $r15Runner $r15RunnerBytes $r15RunnerSha256 'J01 R15 runner predecessor'
    Assert-File $r15Binary $r15BinaryBytes $r15BinarySha256 'J01 R15 binary predecessor'
    Assert-File $r15PredecessorStaticRelease $r15PredecessorStaticReleaseBytes $r15PredecessorStaticReleaseSha256 'J01 R15 static release predecessor'
    Assert-File $r15PredecessorCreateActivation $r15PredecessorCreateActivationBytes $r15PredecessorCreateActivationSha256 'J01 R15 Create activation predecessor'
    foreach ($path in $r15AbsentSuccessOutputs) {
        if (Test-Path -LiteralPath $path) { throw "J01 R15 unexpectedly produced a CAD success-state output: $path" }
    }
    $r15Incident = Get-Content -Raw -Encoding UTF8 -LiteralPath $r15PrelaunchIncident | ConvertFrom-Json
    if ($r15Incident.schema -ne 'B51R1_S05R2_J01_R15_PRELAUNCH_FAIL_CLOSED_INCIDENT_V1' -or
        $r15Incident.status -ne 'S05R2_J01_R15_PRELAUNCH_FAIL_CLOSED' -or
        $r15Incident.gate_pass -isnot [bool] -or $r15Incident.gate_pass -ne $false -or
        [string]$r15Incident.failure_phase -ne 'RECOVERY_PREREQUISITE_VALIDATION_BEFORE_START_PROCESS' -or
        [string]$r15Incident.exception_type -ne 'System.Management.Automation.PropertyNotFoundException' -or
        [string]$r15Incident.exception -notmatch "property 'feature_returned' cannot be found" -or
        [string]$r15Incident.root_cause -notmatch 'fifth mate-attempt object legitimately has no feature_returned property' -or
        [long]$r15Incident.solidworks_start_process_call_count -ne $r15PrelaunchStartProcessCallCount -or
        [long]$r15Incident.solidworks_process_count_before -ne 0 -or
        [long]$r15Incident.solidworks_process_count_after -ne 0 -or
        [long]$r15Incident.cad_com_call_count -ne 0 -or
        $r15Incident.cad_output_created -ne $false -or
        $r15Incident.r15_session_outputs_absent -ne $true -or
        $r15Incident.r15_j00_checkpoint_absent -ne $true -or
        $r15Incident.r15_pilot_output_absent -ne $true -or
        $r15Incident.r15_create_gate_absent -ne $true -or
        $r15Incident.r15_cold_activation_absent -ne $true -or
        $null -ne $r15Incident.PSObject.Properties['expected_process_id'] -or
        $null -ne $r15Incident.PSObject.Properties['solidworks_process_id'] -or
        [string]$r15Incident.required_recovery -ne 'APPEND_ONLY_R16_WITH_PROPERTY_SAFE_R14_ATTEMPT_VALIDATION_AND_INDEPENDENT_CREATE_ACTIVATION' -or
        $r15Incident.r15_artifacts_immutable -ne $true -or
        $r15Incident.formal_s05_authorized -ne $false -or
        $r15Incident.cold_verify_authorized -ne $false -or
        $r15Incident.g4_authorized -ne $false -or $r15Incident.t005_authorized -ne $false) {
        throw 'J01 R15 prelaunch incident boundary mismatch'
    }
    foreach ($binding in @(
        [ordered]@{actual=$r15Incident.tool.source;path=$r15Source;bytes=$r15SourceBytes;sha256=$r15SourceSha256;label='source'},
        [ordered]@{actual=$r15Incident.tool.runner;path=$r15Runner;bytes=$r15RunnerBytes;sha256=$r15RunnerSha256;label='runner'},
        [ordered]@{actual=$r15Incident.tool.binary;path=$r15Binary;bytes=$r15BinaryBytes;sha256=$r15BinarySha256;label='binary'},
        [ordered]@{actual=$r15Incident.tool.static_release;path=$r15PredecessorStaticRelease;bytes=$r15PredecessorStaticReleaseBytes;sha256=$r15PredecessorStaticReleaseSha256;label='static release'},
        [ordered]@{actual=$r15Incident.tool.create_activation;path=$r15PredecessorCreateActivation;bytes=$r15PredecessorCreateActivationBytes;sha256=$r15PredecessorCreateActivationSha256;label='Create activation'}
    )) {
        if ([IO.Path]::GetFullPath((Join-Path $root ([string]$binding.actual.path))) -ne [IO.Path]::GetFullPath([string]$binding.path) -or
            [long]$binding.actual.bytes -ne [long]$binding.bytes -or
            [string]$binding.actual.sha256 -ne [string]$binding.sha256) {
            throw "J01 R15 incident $($binding.label) binding mismatch"
        }
    }
    $r15Release = Get-Content -Raw -Encoding UTF8 -LiteralPath $r15PredecessorStaticRelease | ConvertFrom-Json
    $r15ActivationState = Get-Content -Raw -Encoding UTF8 -LiteralPath $r15PredecessorCreateActivation | ConvertFrom-Json
    if ($r15Release.schema -ne 'B51R1_S05R2_J01_R15_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1' -or
        $r15Release.status -ne 'STATIC_RELEASE_PASS' -or $r15Release.gate_pass -ne $true -or
        $r15Release.runtime_executed -ne $false -or [long]$r15Release.recovery_prerequisite_count -ne 15 -or
        [long]$r15Release.runner.r14_transaction_closure_artifact_count -ne 10 -or
        [long]$r15Release.runner.create_locked_item_count -ne 87 -or
        [long]$r15Release.runner.cold_verify_locked_item_count -ne 90 -or
        $r15Release.create_activation_authorized -ne $true -or
        $r15Release.cold_verify_activation_authorized -ne $false -or
        $r15ActivationState.activation_mode -ne 'CREATE_ONLY' -or
        [long]$r15ActivationState.required_counts.recovery_prerequisites -ne 15 -or
        [long]$r15ActivationState.required_counts.predecessor_transaction_closure_artifacts -ne 10 -or
        [long]$r15ActivationState.required_counts.create_locked_items -ne 87 -or
        $r15ActivationState.create_authorized -ne $true -or $r15ActivationState.cold_verify_authorized -ne $false -or
        $r15ActivationState.formal_s05_authorized -ne $false -or $r15ActivationState.t005_authorized -ne $false) {
        throw 'J01 R15 predecessor static release/Create activation contract mismatch'
    }
    ...
    return @(
        ...
        [ordered]@{
            id='J01_R14_PRECREATE_ENTITIES_GETTER_OBJECTARRAY_FAIL_CLOSED';path=$r14FailureReceipt
            bytes=$r14FailureReceiptBytes;sha256=$r14FailureReceiptSha256;status=[string]$r14Failed.status
            exception_type=[string]$r14Failed.exception_type;failed_boundary='PRECREATE_ENTITIES_TO_MATE_GETTER_OBJECTARRAY_GATE'
            entity_marks=@(1,1,67108864);acquisition_selection_count=3;create_preselection_count=0
            entities_to_mate_assigned=$true;reference_entity_assigned=$false
            create_mate_data_call_count=5;create_mate_call_count=4
            j00_mates_created=3;hinge_created=$true;save_as_call_count=1;mechanical_outputs_partial=$true
            partial_j00_snapshot=[ordered]@{path=$r14PartialJ00Assembly;bytes=$r14PartialJ00AssemblyBytes;sha256=$r14PartialJ00AssemblySha256}
            mr2_hashes_stable=$true;success_state_outputs_absent=$true
            formal_s05_output_allowed=$false;t005_authorized=$false
            recovery_action='TREAT_PRECREATE_ENTITIES_TO_MATE_GETTER_SHAPE_AS_DIAGNOSTIC_ONLY_THEN_CALL_CREATE_MATE'
        },
        [ordered]@{
            id='J01_R15_PRELAUNCH_OPTIONAL_PROPERTY_VALIDATION_FAIL_CLOSED';path=$r15PrelaunchIncident
            bytes=$r15PrelaunchIncidentBytes;sha256=$r15PrelaunchIncidentSha256;status=[string]$r15Incident.status
            exception_type=[string]$r15Incident.exception_type;failure_phase=[string]$r15Incident.failure_phase
            solidworks_start_process_call_count=$r15PrelaunchStartProcessCallCount
            solidworks_process_count_before=0;solidworks_process_count_after=0;cad_com_call_count=0
            predecessor_process_id=$null;cad_output_created=$false;success_state_outputs_absent=$true
            static_closure_artifact_count=6;formal_s05_output_allowed=$false;t005_authorized=$false
            recovery_action='PROPERTY_SAFE_R14_OPTIONAL_MATE_ATTEMPT_VALIDATION_BEFORE_START_PROCESS'
        }
    )
}
...
Assert-File $toolCompiler $toolCompilerBytes $toolCompilerSha256 'J01 R16 frozen-tool compiler provenance'
if ($toolDllBytes -le 0 -or $toolDllSha256 -eq ('0' * 64)) {
    throw 'J01 R16 is source-only: deterministic compile and append-only binary static freeze are required before execution'
}
...
if ($persistentSoftwareOglBefore -ne 0) {
    throw 'Persistent Use Software OGL must remain disabled; R16 authorizes only the one-session launch argument'
}

$mr2Inputs = @(Get-Mr2PilotInputs)
$recoveryPrerequisites = @(Get-RecoveryPrerequisites)
if ($recoveryPrerequisites.Count -ne 16) {
    throw "J01 R16 recovery prerequisite count mismatch: $($recoveryPrerequisites.Count)"
}
...
$r14PredecessorPidPresent = @(Get-Process -Id 52552 -ErrorAction SilentlyContinue).Count -ne 0
if ($prelaunchSolidWorksCount -ne 0 -or $r9PredecessorPidPresent -or $r10PredecessorPidPresent -or
    $r11PredecessorPidPresent -or $r12PredecessorPidPresent -or $r13PredecessorPidPresent -or
    $r14PredecessorPidPresent) {
    throw 'J01 R16 predecessor process boundary is not clean immediately before launch'
}
$mr2LockedArtifacts = @(
...
$r14ClosureLockedArtifacts = @(
    [ordered]@{id='J01_R14_INPUT_LOCK';path=$r14FailureInputLock;bytes=$r14FailureInputLockBytes;sha256=$r14FailureInputLockSha256},
    [ordered]@{id='J01_R14_READINESS';path=$r14FailureReadiness;bytes=$r14FailureReadinessBytes;sha256=$r14FailureReadinessSha256},
    [ordered]@{id='J01_R14_PROGRESS';path=$r14FailureProgress;bytes=$r14FailureProgressBytes;sha256=$r14FailureProgressSha256},
    [ordered]@{id='J01_R14_PARTIAL_J00_ASSEMBLY';path=$r14PartialJ00Assembly;bytes=$r14PartialJ00AssemblyBytes;sha256=$r14PartialJ00AssemblySha256},
    [ordered]@{id='J01_R14_STATIC_RELEASE';path=$r14PredecessorStaticRelease;bytes=$r14PredecessorStaticReleaseBytes;sha256=$r14PredecessorStaticReleaseSha256},
    [ordered]@{id='J01_R14_ACTIVATION';path=$r14PredecessorCreateActivation;bytes=$r14PredecessorCreateActivationBytes;sha256=$r14PredecessorCreateActivationSha256},
    [ordered]@{id='J01_R14_SOURCE';path=$r14Source;bytes=$r14SourceBytes;sha256=$r14SourceSha256},
    [ordered]@{id='J01_R14_RUNNER';path=$r14Runner;bytes=$r14RunnerBytes;sha256=$r14RunnerSha256},
    [ordered]@{id='J01_R14_BINARY';path=$r14Binary;bytes=$r14BinaryBytes;sha256=$r14BinarySha256}
)
$r15ClosureLockedArtifacts = @(
    [ordered]@{id='J01_R15_SOURCE';path=$r15Source;bytes=$r15SourceBytes;sha256=$r15SourceSha256},
    [ordered]@{id='J01_R15_RUNNER';path=$r15Runner;bytes=$r15RunnerBytes;sha256=$r15RunnerSha256},
    [ordered]@{id='J01_R15_BINARY';path=$r15Binary;bytes=$r15BinaryBytes;sha256=$r15BinarySha256},
    [ordered]@{id='J01_R15_STATIC_RELEASE';path=$r15PredecessorStaticRelease;bytes=$r15PredecessorStaticReleaseBytes;sha256=$r15PredecessorStaticReleaseSha256},
    [ordered]@{id='J01_R15_CREATE_ACTIVATION';path=$r15PredecessorCreateActivation;bytes=$r15PredecessorCreateActivationBytes;sha256=$r15PredecessorCreateActivationSha256}
)
$recoveryLockedArtifacts = @($recoveryPrerequisites) + @($r8ClosureLockedArtifacts) +
    ...
    @($r12ClosureLockedArtifacts) + @($r13ClosureLockedArtifacts) + @($r14ClosureLockedArtifacts) +
    @($r15ClosureLockedArtifacts)

$readinessReceipt = Join-Path $sessionRoot "B51R1_S05R2_J01_R16_$($Mode.ToUpperInvariant())_READINESS_RECEIPT.json"
$inputLock = Join-Path $sessionRoot "B51R1_S05R2_J01_R16_$($Mode.ToUpperInvariant())_INPUT_LOCK.json"
...
if ($Mode -eq 'ColdVerify') {
    ...
    if ($created.schema -ne 'B51R1_S05R2_J01_R16_NATIVE_1R_CREATE_GATE_V1' -or
        $created.status -ne 'S05R2_J01_R16_NATIVE_1R_PILOT_CREATE_PASS' -or
        $created.gate_pass -isnot [bool] -or $created.gate_pass -ne $true) {
        throw 'J01 R16 Create Gate is not PASS'
    }
    if ($created.cold_reopen_authorized -isnot [bool] -or $created.cold_reopen_authorized -ne $false) {
        throw 'J01 R16 Create Gate improperly self-authorizes cold reopen'
    }
    ...
    if ($createdReceipt.schema -ne 'B51R1_S05R2_J01_R16_NATIVE_PILOT_CREATE_V1' -or
        $createdReceipt.status -ne 'S05R2_J01_R16_NATIVE_1R_PILOT_CREATE_PASS' -or
        $createdReceipt.gate_pass -isnot [bool] -or $createdReceipt.gate_pass -ne $true) {
        throw 'J01 R16 Create receipt is not PASS'
    }
    ...
    $coldLockedArtifacts = @(
        [ordered]@{id='J01_R16_CREATE_GATE';path=$createGate;bytes=(Get-Item $createGate).Length;sha256=Get-Sha $createGate},
        [ordered]@{id='J01_R16_CREATE_RECEIPT';path=$createReceipt;bytes=[long]$created.receipt.bytes;sha256=[string]$created.receipt.sha256},
        [ordered]@{id='J01_R16_PILOT_ASSEMBLY';path=$pilotAssembly;bytes=[long]$created.output.bytes;sha256=[string]$created.output.sha256}
    )
}
...
try {
    ...
    if ($persistentSoftwareOglAfterLaunch -ne 0) {
        throw 'R16 one-session Software OpenGL launch changed the persistent registry value'
    }
    ...
    $expectedLockedItemCount = if ($Mode -eq 'Create') { 93 } else { 96 }
    if ($lockedItems.Count -ne $expectedLockedItemCount) {
        throw "J01 R16 locked item count mismatch: expected=$expectedLockedItemCount actual=$($lockedItems.Count)"
    }
    $lock = [ordered]@{
        schema="B51R1_S05R2_J01_R16_$($Mode.ToUpperInvariant())_INPUT_LOCK_V1"
        generated_at=[DateTimeOffset]::Now.ToString('o')
        status="PASS_S05R2_J01_R16_$($Mode.ToUpperInvariant())_INPUTS_HASH_LOCKED"
        mode=$Mode
        runtime_boundary=[ordered]@{
            ...
            r14_predecessor_process_id=52552;r14_predecessor_pid_present=$r14PredecessorPidPresent
            r15_predecessor_process_id=$null;r15_prelaunch_start_process_call_count=$r15PrelaunchStartProcessCallCount
        ...
        claim_limit='J01_R16_ONE_SESSION_SOFTWARE_OPENGL_TYPED_MATE_ENTITY_RECOVERY_NATIVE_1R_PILOT_ONLY_NO_FORMAL_S05_G4_T005_OR_FLIGHT_CREDIT'
    }
    Write-JsonCreateNew $inputLock $lock

    [void][Reflection.Assembly]::LoadFile((Resolve-Path -LiteralPath $toolDll).Path)
    if ($Mode -eq 'Create') {
        $result = [B51R1S05R2J01R16NativePilotTool]::Create(
        ...
        if ($data.schema -ne 'B51R1_S05R2_J01_R16_NATIVE_PILOT_CREATE_V1' -or
            $data.status -ne 'S05R2_J01_R16_NATIVE_1R_PILOT_CREATE_PASS' -or
        ...
        if ($mateAttempts.Count -ne 5 -or @($data.native_mate_creation).Count -ne 5 -or
            ...
            throw 'J01 R16 Mate API call ledger count mismatch'
        }
        ...
        foreach ($index in 0..4) {
            ...
            if ([long]$attempt.create_mate_data_call_index -ne ($index + 1) -or
                ...
                throw "J01 R16 Mate API call ledger mismatch at index $index"
            }
        }
        ...
        if ([long]$angleAttempt.selection_count_before_direct_property_contract_clear -ne 3 -or
            ...
            $angleAttempt.precreate_entities_to_mate_getter_diagnostic_only -isnot [bool] -or
            $angleAttempt.precreate_entities_to_mate_getter_diagnostic_only -ne $true -or
            $null -eq $angleAttempt.PSObject.Properties['precreate_entities_to_mate_getter_raw_summary'] -or
            $null -eq $angleAttempt.PSObject.Properties['precreate_entities_to_mate_getter_is_null'] -or
            $angleAttempt.precreate_entities_to_mate_getter_is_null -isnot [bool] -or
            $null -eq $angleAttempt.PSObject.Properties['precreate_entities_to_mate_getter_is_array'] -or
            $angleAttempt.precreate_entities_to_mate_getter_is_array -isnot [bool] -or
            $null -eq $angleAttempt.PSObject.Properties['precreate_entities_to_mate_getter_managed_type'] -or
            $null -eq $angleAttempt.PSObject.Properties['precreate_entities_to_mate_getter_count'] -or
            $null -eq $angleAttempt.PSObject.Properties['precreate_entities_to_mate'] -or
            $angleAttempt.precreate_entities_to_mate_getter_count_is_diagnostic_only -isnot [bool] -or
            $angleAttempt.precreate_entities_to_mate_getter_count_is_diagnostic_only -ne $true -or
            ...
            throw 'J01 R16 Limit Angle direct-property input-channel ledger mismatch'
        }
        if ($angleAttempt.precreate_entities_to_mate_getter_is_null) {
            if ($angleAttempt.precreate_entities_to_mate_getter_is_array -ne $false -or
                $null -ne $angleAttempt.precreate_entities_to_mate_getter_managed_type -or
                $null -ne $angleAttempt.precreate_entities_to_mate_getter_count -or
                $null -ne $angleAttempt.precreate_entities_to_mate) {
                throw 'J01 R16 null EntitiesToMate getter diagnostics are not self-consistent'
            }
        }
        elseif ($angleAttempt.precreate_entities_to_mate_getter_is_array) {
            if ([string]::IsNullOrWhiteSpace([string]$angleAttempt.precreate_entities_to_mate_getter_managed_type) -or
                $null -eq $angleAttempt.precreate_entities_to_mate_getter_count -or
                [long]$angleAttempt.precreate_entities_to_mate_getter_count -lt 0 -or
                @($angleAttempt.precreate_entities_to_mate).Count -ne [long]$angleAttempt.precreate_entities_to_mate_getter_count) {
                throw 'J01 R16 array EntitiesToMate getter diagnostics are not self-consistent'
            }
        }
        else {
            if ([string]::IsNullOrWhiteSpace([string]$angleAttempt.precreate_entities_to_mate_getter_managed_type) -or
                $null -ne $angleAttempt.precreate_entities_to_mate_getter_count -or
                $null -ne $angleAttempt.precreate_entities_to_mate) {
                throw 'J01 R16 scalar EntitiesToMate getter diagnostics are not self-consistent'
            }
        }
        ...
        foreach ($index in 0..12) {
            ...
            if ([long]$selection.select_by_id2_call_index -ne ($index + 1) -or
                ...
                throw "J01 R16 selection identity/mark ledger mismatch at index $index"
            }
            ...
            if ($isAssemblyRoot) {
                if ($selection.direct_corresponding_specific_diagnostic_only -ne $false -or
                    ...
                    throw "J01 R16 assembly-root selection unexpectedly has a component owner at index $index"
                }
            }
            else {
                ...
                if ($selection.direct_corresponding_specific_diagnostic_only -ne $true -or
                    ...
                    throw "J01 R16 selected owner binding mismatch at index $index"
                }
            }
            if ($null -ne $selection.selected_feature_matches_context_feature -and
                ...
                throw "J01 R16 selected context-Feature identity mismatch at index $index"
            }
        }
        ...
        if ($preloads.Count -ne 2 -or [long]$data.document_count_before_new_assembly -ne 2 -or
            ...
            throw 'J01 R16 preload count or assembly document-count transition mismatch'
        }
        foreach ($index in 0..1) {
            ...
            if ([string]$preload.role -ne $expectedRole -or
                ...
                throw "J01 R16 strict preload evidence mismatch: $expectedRole"
            }
        }
        ...
        $gate = [ordered]@{
            schema='B51R1_S05R2_J01_R16_NATIVE_1R_CREATE_GATE_V1';generated_at=[DateTimeOffset]::Now.ToString('o')
            status='S05R2_J01_R16_NATIVE_1R_PILOT_CREATE_PASS';gate_pass=$true
            ...
            claim_limit='J01_R16_SELECTIONMGR_BOUND_TYPED_MATE_ENTITY_RECOVERY_CREATE_AND_SAME_DOCUMENT_DRIVER_EVIDENCE_ONLY_PENDING_INDEPENDENT_COLD_REOPEN'
        }
        Write-JsonCreateNew $createGate $gate
        Write-Output $createGate
    }
    else {
        $result = [B51R1S05R2J01R16NativePilotTool]::ColdVerify(
        ...
        if ($data.schema -ne 'B51R1_S05R2_J01_R16_NATIVE_PILOT_COLD_REOPEN_V1' -or
            $data.status -ne 'S05R2_J01_R16_NATIVE_1R_PILOT_COLD_REOPEN_PASS' -or
            $data.gate_pass -isnot [bool] -or $data.gate_pass -ne $true) {
            throw 'J01 R16 ColdVerify receipt is not PASS'
        }
        if ($data.transform2_call_count -ne 0 -or $data.set_transform_and_solve_call_count -ne 0 -or
        ...
        if ($resolution.Count -lt 2 -or $expectedIdentities.Count -ne 2 -or
            ...
            throw 'J01 R16 ColdVerify did not resolve parent and child uniquely in one component traversal'
        }
        foreach ($role in @('parent','child')) {
            ...
            if ($identity.Count -ne 1 -or $match.Count -ne 1 -or
                ...
                throw "J01 R16 ColdVerify component identity mismatch: $role"
            }
        }
        foreach ($item in $lockedItems) {
        ...
        $gate = [ordered]@{
            schema='B51R1_S05R2_J01_R16_NATIVE_1R_GATE_V1';generated_at=[DateTimeOffset]::Now.ToString('o')
            status='S05R2_J01_R16_NATIVE_1R_PILOT_PASS';gate_pass=$true
            ...
            claim_limit='J01_R16_SELECTIONMGR_BOUND_TYPED_MATE_ENTITY_RECOVERY_NATIVE_1R_PILOT_GATE_ONLY_NO_COMPLETE_CHAIN_G4_T005_STRUCTURAL_MANUFACTURING_OR_FLIGHT_CREDIT'
        }
