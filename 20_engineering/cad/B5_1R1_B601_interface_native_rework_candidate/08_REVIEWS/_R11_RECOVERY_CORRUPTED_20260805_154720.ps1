...
$r10StaticRelease = Join-Path $PSScriptRoot 'B51R1_S05R2_J01_R11_NATIVE_PILOT_TOOL_STATIC_RELEASE_V1.json'
$r10CreateActivation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R15A_POOL_A_A08R2_J01_R11_SELECTION_LEDGER_NATIVE_1R_PILOT_CREATE_ACTIVATION.json'
$r10ColdActivation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R16A_POOL_A_A08R2_J01_R11_SELECTION_LEDGER_NATIVE_1R_PILOT_COLD_VERIFY_ACTIVATION.json'
...
$r8Activation = Join-Path $root '04_CONFIGURATION\B51R1_AUTONOMOUS_SESSION_PLAN_V22R11A_POOL_A_A08R2_J01_R8_SOFTWARE_OGL_NATIVE_1R_PILOT_CREATE_ACTIVATION.yaml'
...
function Get-ModeActivation([string]$RequestedMode) {
    ...
    Assert-File $r10StaticRelease ([long]$activation.static_release.bytes) ([string]$activation.static_release.sha256) 'J01 R11 static release bound by activation'
