...
public static class B51R1A03R1PropertyWriterQualificationV2
{
        ...
        int expectedProcessId, string templatePath, string outputPartPath, string receiptPath)
    {
        ...
        {
            {"schema", "B51R1_A03_R1_PROPERTY_WRITER_FIRST_PASS_RECEIPT_V2"},
        ...
        string receiptPath)
    {
        var receipt = new Dictionary<string, object>
        {
            {"schema", "B51R1_A03_R1_PROPERTY_WRITER_SECOND_PASS_RECEIPT_V2"},
            {"generated_at_utc", DateTime.UtcNow.ToString("o")},
            {"status", "FAIL_CLOSED_NOT_STARTED"},
            {"expected_process_id", expectedProcessId},
