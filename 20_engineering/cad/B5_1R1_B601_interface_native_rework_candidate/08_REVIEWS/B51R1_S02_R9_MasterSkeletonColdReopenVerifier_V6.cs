...
public static class B51R1S02R9MasterSkeletonColdReopenVerifierV6
{
        ...
        string expectedFinalLockSha256)
    {
        ...
        {
            {"schema", "B51R1_S02_R9_MASTER_SKELETON_COLD_REOPEN_RECEIPT_V6"},
            {"session_id", "S02_R9"},
            {"generated_at_utc", DateTime.UtcNow.ToString("o")},
            {"status", "S02_R9_FAIL_CLOSED_NOT_STARTED"},
        ...
        try
        {
            ...
            receipt["status"] = "S02_R9_MASTER_SKELETON_COLD_REOPEN_PASS";
        ...
        {
            receipt["status"] = "S02_R9_FAIL_CLOSED";
