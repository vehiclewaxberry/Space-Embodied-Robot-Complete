...
public static class B51R1S02R2MasterSkeletonColdReopenVerifierV4
{
        ...
        string expectedFinalLockSha256)
    {
        ...
        {
            {"schema", "B51R1_S02_R2_MASTER_SKELETON_COLD_REOPEN_RECEIPT_V4"},
            {"session_id", "S02_R2"},
        ...
        try
        {
            ...
            receipt["status"] = "S02_R2_MASTER_SKELETON_COLD_REOPEN_PASS";
