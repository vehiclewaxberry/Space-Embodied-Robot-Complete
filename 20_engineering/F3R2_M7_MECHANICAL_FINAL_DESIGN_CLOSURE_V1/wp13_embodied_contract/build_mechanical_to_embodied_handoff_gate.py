...
# -*- coding: utf-8 -*-
"""
M7 / WP13 - MECHANICAL_TO_EMBODIED_HANDOFF_GATE builder        (ODR-16)

Machine-check handoff gate between the Terminal Mechanical Closure and the
downstream consumers (Sim16 / Physics-Gated RL).  Per ODR-16 this gate does
NOT restate the 18 mechanical criteria; it machine-checks that a downstream
consumer can actually LOAD and reason about the assets pinned by
...
OUT_PATH = os.path.join(OUT_DIR, "MECHANICAL_TO_EMBODIED_HANDOFF_GATE.json")
TZ8 = datetime.timezone(datetime.timedelta(hours=8))

CONTRACT_REL = f"{M7_REL}/wp13_embodied_contract/EMBODIED_MECHANICAL_CONTRACT_V1.yaml"
V4_REL = f"{M7_REL}/wp10_mech_rl_v4/MECH_DYNAMICS_INTERFACE_V4.yaml"
URDF_REL = "20_engineering/cad/spacecraft_layout/arm_b601_v1/arm_b601_v1.urdf"
MASS_REL = f"{M7_REL}/wp2_design_mass/SYSTEM_DESIGN_MASS_PROPERTIES_V2.yaml"
