#!/usr/bin/env python
"""Independent numerical recomputation for the isolated Solar R2 HF/ROM V3.
...
PKG = HERE.parent
ROOT = PKG.parents[3]
NPZ = PKG / "R2_HF_ROM_NUMERICAL_DATA_V3.npz"
ROM_JSON = PKG / "R2_SEVEN_MODE_ROM_V3.json"
EVID_JSON = PKG / "R2_HF_NUMERICAL_EVIDENCE_V3.json"
MODEL_YAML = PKG / "R2_HF_MODEL_V3.yaml"
OUT = HERE / "INDEPENDENT_RECOMPUTE_V3.json"
...
def main() -> None:
    ...
    report = {
        "schema": "R2_HF_ROM_INDEPENDENT_RECOMPUTE_V3",
