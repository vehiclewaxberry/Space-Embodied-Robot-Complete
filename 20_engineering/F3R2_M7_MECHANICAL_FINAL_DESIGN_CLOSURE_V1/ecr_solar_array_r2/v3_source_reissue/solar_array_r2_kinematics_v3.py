# -*- coding: utf-8 -*-
"""SOLAR_ARRAY_R2 V3 kinematics source (pure Python, no FreeCAD dependency).
...
D-R2-03  Leaf total assembly thickness 2.5 mm (upper bound of the ODR-19
         ...
         stowed inter-leaf gap -> 8.5 mm stack, 9.5 mm protrusion beyond
...
# V3 is a source/metadata reissue. Numerical kinematics are intentionally
# identical to the frozen V1 source; no CAD is generated by importing this file.
...
LEAF1_MID_Y = SIDE_FACE_Y + STACK_STANDOFF + LEAF_T / 2.0   # 115.4 = 113.15 + 1.0 + 2.5/2
