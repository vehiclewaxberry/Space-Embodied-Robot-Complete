...
stowed engaged interface is covered in SOLAR_ARRAY_R2_BUILD_REPORT_V3.json
as INTENTIONAL_HDRM_STACK_INTERFACE.

Output: SOLAR_ARRAY_R2_CONTINUOUS_CLEARANCE_V3.json
...
OUTPUT_JSON = HERE / "SOLAR_ARRAY_R2_CONTINUOUS_CLEARANCE_V3.json"
...
def main() -> None:
    ...
    report = {
        "schema": "SOLAR_ARRAY_R2_CONTINUOUS_CLEARANCE_V3",
