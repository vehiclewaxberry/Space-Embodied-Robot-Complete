...
GATE 1 - SOLAR_R2_HARNESS (full 55-state deployment sweep):
  * root service loop per wing: Omega loop of R=25 mm about the root hinge
    line (y=+/-115.4, z=-108.15) in the x=0 plane; bus clamp at the side
...
Outputs: HARNESS_R2_FUNCTIONAL_GATES_V3.json / .yaml
...
from sweep_solar_array_r2_clearance_v3 import sweep_states, make_leaf_solid

PROJECT_ROOT = HERE.parents[3]
ARM_WITNESS_STEP = (PROJECT_ROOT / "20_engineering" / "cad" /
                    "freecad_authoritative" / "B601_KINEMATIC_ASSEMBLY_Q0_WITNESS.step")

OUT_JSON = HERE / "HARNESS_R2_FUNCTIONAL_GATES_V3.json"
OUT_YAML = HERE / "HARNESS_R2_FUNCTIONAL_GATES_V3.yaml"
...
def main():
    ...
    report = {
        "schema": "HARNESS_R2_FUNCTIONAL_GATES_V3",
...
# Dormant V3 source: never run at import time.
