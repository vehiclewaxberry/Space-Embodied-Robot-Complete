...
Produces, in this directory:
  SOLAR_ARRAY_R2_CANDIDATE_V1.FCStd   - stowed + deployed solids, keepouts
  SOLAR_ARRAY_R2_CANDIDATE_V1.step    - neutral export of the same solids
  SOLAR_ARRAY_R2_BUILD_REPORT_V1.json - metrics, masses, first clearance
                                        pairs (non-empty comparison sets),
                                        hashes
  SOLAR_ARRAY_R2_GEOMETRY_CANDIDATE_V1.yaml - product-structure style summary
...
Millimetres throughout.  This builds the R2 ENGINEERING CANDIDATE only;
...
OUTPUT_FCSTD = HERE / "SOLAR_ARRAY_R2_CANDIDATE_V1.FCStd"
OUTPUT_STEP = HERE / "SOLAR_ARRAY_R2_CANDIDATE_V1.step"
BUILD_REPORT = HERE / "SOLAR_ARRAY_R2_BUILD_REPORT_V1.json"
GEOM_YAML = HERE / "SOLAR_ARRAY_R2_GEOMETRY_CANDIDATE_V1.yaml"
...
def main() -> None:
    doc = App.newDocument("SOLAR_ARRAY_R2_CANDIDATE_V1")
    ...
    report = {
        "schema": "SOLAR_ARRAY_R2_BUILD_REPORT_V1",
        ...
        "protrusion_note": (
            "9.0 mm protrusion beyond side face exceeds the generic 6.5 mm "
    ...
    report["hashes"] = {
        ...
        BUILD_REPORT.name: sha256(BUILD_REPORT),
    }
    BUILD_REPORT.write_text(json.dumps(report, indent=2), encoding="utf-8")
...
def geom_yaml(report: dict) -> str:
    ...
    return """schema: SOLAR_ARRAY_R2_GEOMETRY_CANDIDATE_V1
generated_local: '%s'
...
geometry_facts:
  ...
  chord_margins_mm: %s
  root_hinge_line: {y_abs_mm: 114.9, z_mm: -108.15, axis: X_S}
  stowed_z_span_mm: %s
  stack_height_mm: %s
...
""" % (report["generated_local"],
       sm["chord_margins_mm"], sm["stowed_z_span_mm"],
