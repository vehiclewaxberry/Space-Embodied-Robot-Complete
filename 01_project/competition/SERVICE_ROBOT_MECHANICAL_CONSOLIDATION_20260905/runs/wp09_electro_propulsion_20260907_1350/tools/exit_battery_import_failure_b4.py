...
rp=R/'results/battery_mount_NATIVE_BOUNDED_B4.json';d=json.loads(rp.read_text());m.require(d['status']=='FAILED','Not the failed import')
out=R/'results/BATTERY_IMPORT_FAILURE_B4_SESSION_EXIT.json';m.require(not out.exists(),'Protected output')
