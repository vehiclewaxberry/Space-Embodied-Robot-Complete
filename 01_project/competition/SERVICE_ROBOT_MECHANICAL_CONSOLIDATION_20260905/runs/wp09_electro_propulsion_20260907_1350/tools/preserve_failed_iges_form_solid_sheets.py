...
rp=R/'results/battery_mount_NATIVE_BOUNDED_B6.json';d=json.loads(rp.read_text());assert d['status']=='FAILED' and d['documents_before']==[]
out=R/'results/BATTERY_IGES_FORM_SOLID_FAILED_SHEETS_PRESERVED.json';assert not out.exists()
...
try:
    ...
    saved=b.save_new(model,R/'native/failed_iges_form_solid_sheets/WP09_BAT_FIRST_SCREW_7SHEETS_DIAGNOSTIC.SLDPRT');report['preserved_file']=saved
