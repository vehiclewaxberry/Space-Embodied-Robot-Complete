...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('module');ap.add_argument('--batch',type=int,required=True);a=ap.parse_args();kind=a.module
    ep=R/'results'/kind/'EMISSION.json';cp=R/'results'/kind/'CHECK.json'
