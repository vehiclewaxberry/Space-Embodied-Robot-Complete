...
def main():
    ...
    try:
        ...
        sw.SetUserPreferenceIntegerValue(12,3)
        sw.SetUserPreferenceIntegerValue(207,0)
        m.require(sw.GetUserPreferenceIntegerValue(12)==3 and sw.GetUserPreferenceIntegerValue(207)==0,'Direct BRep mapping readback differs')
        report['import_integer_during']={str(k):sw.GetUserPreferenceIntegerValue(k) for k in (12,140,207)}
        report['direct_brep_mapping']=True
