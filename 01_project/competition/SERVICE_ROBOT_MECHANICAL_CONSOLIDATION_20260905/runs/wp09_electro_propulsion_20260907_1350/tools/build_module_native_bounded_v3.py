...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('module');ap.add_argument('--batch',type=int,required=True);ap.add_argument('--local-check',type=Path);ap.add_argument('--emission',type=Path);a=ap.parse_args();kind=a.module
