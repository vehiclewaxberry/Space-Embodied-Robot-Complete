...
out=R/'results/BATTERY_IGES_FORM_SOLID_FAILED_SHEETS_PRESERVED_V2.json';assert not out.exists()
...
try:
    ...
    saved=b.save_new(model,R/'native/iges6/failed_sheets.SLDPRT');report['preserved_file']=saved
