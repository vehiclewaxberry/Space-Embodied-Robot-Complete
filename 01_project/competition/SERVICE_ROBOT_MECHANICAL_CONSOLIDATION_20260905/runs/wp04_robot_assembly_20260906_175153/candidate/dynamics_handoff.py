...
def main():
    ...
    provenance = [Path(__file__).resolve(), model_path, HERE/'design_parameters.json', HERE/'kinematics.py', HERE/'wing_kinematics.py', HERE/'root_structure.py', HERE/'r01_design.py', HERE/'candidate_context.py', HERE/'provenance_binding.py']
    ...
    for data in receipts:
        ...
        for name,value in data['dependency_sha256'].items():
            hashes[str((HERE/name).resolve())]=value
        for key,ref in data.get('composition',{}).items():
