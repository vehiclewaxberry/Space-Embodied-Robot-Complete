...
def affected_ids(P,receipt):
    return [r['id'] for r in receipt['instances'] if r['id'] in ['rear_launch_bulkhead','front_service_cover'] or r['id'].startswith(('R07_','RB_longeron_','RB_lower_spacer_','RB_pillar_tierod_','RB_pillar_top_washer_','RB_end_screw_','shear_web_','wing_root_fork_','hold_roof_lug_','hold_pivot_clevis_'))]
