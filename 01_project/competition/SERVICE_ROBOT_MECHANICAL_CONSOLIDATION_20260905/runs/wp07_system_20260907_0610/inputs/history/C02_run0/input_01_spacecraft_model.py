    ...
    for side in [-1,1]:
        ...
        for x in [-150,-90,-30,30,90,150]:
            for z in [-94,94]:
                ...
                inner_y=101.15 if x==150 else 100.15
                add(rod((x+4,side*inner_y,z),(x+4,side*110.15,z),3),f'shear_web_screw_{side}_{x}_{z}',mount=f'shear_clip_{side}_{x}_{z}',rep='SIMPLIFIED_PROXY',density=None,color=DARK,basis='M3_THREADLESS_FASTENER_ENVELOPE; X150_TAIL_FLUSH_TO_WEB_INNER_FACE')
