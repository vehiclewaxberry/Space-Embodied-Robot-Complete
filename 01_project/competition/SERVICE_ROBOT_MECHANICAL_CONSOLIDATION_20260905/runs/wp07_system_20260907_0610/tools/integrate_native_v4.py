"""WP07 V4: componentwise cold inspection and explicit native-only delivery.
...
import check_native_delivery_v2 as independent
from integrate_native import R, require, sha, normalized, val, t16, IDENTITY16


class IntegratorV4(fast.FastIntegrator, v2.IntegratorV2):
...
def main():
    ...
    try:
        ...
        builder = IntegratorV4(output, report)
        ...
        require(report['inputs_unchanged'], 'Pinned input changed during V4 native integration')
