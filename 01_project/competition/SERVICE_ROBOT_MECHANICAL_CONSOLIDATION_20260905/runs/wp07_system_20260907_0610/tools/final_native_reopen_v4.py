...
def main():
    ...
    output = R/'results/FINAL_REOPEN_SERVICE_V4.json'
    ...
    report = dict(schema='WP07_FINAL_NATIVE_REOPEN_V4', state='service', status='RUNNING', progress=[],
    ...
    try:
        ...
        if not args.no_screenshot:
            ...
            bmp = R/'results/WP07_SERVICE_FINAL_V4.bmp'
