...
HERE = RUN / "candidate"
OUT = RUN / "review/ACTUAL_LEDGER_RECHECK.json"
CHECKS = []
...
def main():
    ...
    result = dict(schema="WP03_INDEPENDENT_ACTUAL_LEDGER_RECHECK_V1", scope="Read-only actual final candidate ledger and source audit; independent stdlib fsum and parallel-axis arithmetic",
