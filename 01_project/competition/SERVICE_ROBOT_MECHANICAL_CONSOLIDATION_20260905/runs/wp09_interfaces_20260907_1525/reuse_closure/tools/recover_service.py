...
h=d.h;m=d.m
out=N/'results/NATIVE_SERVICE_RECOVERY.json';assert not out.exists()
prior=F/'results/NATIVE_SERVICE.json';r=json.loads(prior.read_text());rows=r['rows'];target=N/'mechanical/native/WP09R_SERVICE.SLDASM';th=m.sha(target)
