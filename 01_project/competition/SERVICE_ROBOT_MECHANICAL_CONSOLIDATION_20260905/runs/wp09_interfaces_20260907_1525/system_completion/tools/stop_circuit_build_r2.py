...
part('U119','SN74AHCT1G125DBVR',[(1,'OE_N','input',G),(2,'A','input','RUN_LATCH'),(3,'GND','power_in',G),(4,'Y','output','RUN_LEVEL_5V'),(5,'VCC','power_in',V5)],'SN74AHCT1G125 Rev P p4/5; input II at VCC0..5.5V; same 5V domain as UCC')
two('R123','47k 1%','RUN_LATCH',G)
two('C129','100nF X7R 16V 10%',V5,G)
...
for p in parts:
 ...
 if p['ref'][0]=='R':
  ...
  elif p['ref']=='R105':p['package_reference_unverified']='Resistor_SMD:R_0805_2012Metric';p['mpn']='TNPW0805510KBEEA';p['source']='Vishay TNPW e3 28758 order code,0.1%,25ppm/C';p['scope']='SERIES_ORDER_CODE_SELECTED'
...
s=f'(kicad_sch (version 20250114) (generator "eeschema") (generator_version "10.0") (uuid {q(root)}) (paper "A1") (title_block (title "WP09D stop watchdog, reset/start latch and GX11 driver") (date "2026-09-08") (rev "CIRCUIT_CANDIDATE_R1")) (lib_symbols {"".join(defs)}) {"".join(instances)} {"".join(wires)} (text {q(notes)} (at 20 570 0) (effects (font (size 1.5 1.5)) (justify left)) (uuid {q(uid("notes"))})) (sheet_instances (path "/" (page "1"))))'
