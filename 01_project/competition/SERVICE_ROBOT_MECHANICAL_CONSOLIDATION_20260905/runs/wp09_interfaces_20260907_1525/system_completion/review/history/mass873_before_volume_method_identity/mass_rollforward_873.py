...
def main():
    ...
    for ident in sorted(ids):
        ...
        if ident in rparts:
            ...
            out.update(accounting_basis='REBUILT_FRAME_STEP_AL2700_CANDIDATE_MODEL',candidate_material_mass_kg=mass,source_bound_volume_mm3=p['volume_mm3'],density_kg_mm3=2.7e-6,actual_volume_receipt=str(solarpath)+'#/emitted_parts/'+ident,note='Remove old source-volume mass and insert rebuilt source-volume mass; fixed candidate density retained.')
