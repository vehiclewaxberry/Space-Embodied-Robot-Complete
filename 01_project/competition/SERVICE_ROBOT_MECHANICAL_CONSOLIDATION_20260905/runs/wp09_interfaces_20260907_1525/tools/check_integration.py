...
def main():
    c=json.loads((R/'inputs/INTEGRATION_HARNESS_CONTRACT_V6.json').read_text());e=json.loads((R/'results/EMISSION_V6.json').read_text());pins=dict(c['source_inputs'])
    ...
    write(R/'results/INTEGRATION_CHECK_V6.json',result)
