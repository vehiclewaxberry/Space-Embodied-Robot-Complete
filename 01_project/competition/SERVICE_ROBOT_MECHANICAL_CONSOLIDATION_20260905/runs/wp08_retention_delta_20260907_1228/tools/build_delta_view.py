...
TARGET = OUT / 'WP08_SERVICE_RETENTION_DELTA.glb'
REPORT = OUT / 'DISPLAY_DELTA_CHECK.json'
...
def main():
    ...
    report = dict(schema='WP08_DISPLAY_DELTA_V1', status='RUNNING', source_sha256={},
    ...
    try:
        ...
        for name in sorted(changed):
            ...
            require(not any(data.get(k) for k in ('skins','animations','images','textures','extensionsUsed','extensionsRequired')), 'Unsupported GLB')
