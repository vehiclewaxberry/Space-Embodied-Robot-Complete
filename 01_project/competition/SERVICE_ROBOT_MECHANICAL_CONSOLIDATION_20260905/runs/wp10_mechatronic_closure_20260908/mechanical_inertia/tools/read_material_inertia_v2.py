...
for job in jobs['rows'][args.start:args.end]:
    ...
    start=time.monotonic();r={'worker_sha256':sha(__file__),'method_revision':'V2_GK_LOCAL_DEFAULT_POSE','index':job['index'],'source':job['source'],'instances':job['instances'],'status':'RUNNING'}
    try:
