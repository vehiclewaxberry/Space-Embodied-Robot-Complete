...
|对象|同源计算结果|适用范围|
|---|---|---|
|启动偏置|名义5.990349V，敏感性5.763917–6.220705V|LT偏流和电阻条件见JSON|
|输入欠压|下降15.128023–15.981030V；释放上界筛选16.460179V|独立于预充PGD，不是主功率UVLO替代|
|PGD低态|最大下拉筛选1.882709mA|含MR内部最小70k上拉；2mA测试条件迁移仍有界|
|PGD连接开路|MR最高0.786097V|R221或其下游断开；不覆盖U201内部开漏失效|
|门极与RESET共网|5.337664–6.461819V|同时核对5V导通电阻测试点与RESET6.5V工作上限|
