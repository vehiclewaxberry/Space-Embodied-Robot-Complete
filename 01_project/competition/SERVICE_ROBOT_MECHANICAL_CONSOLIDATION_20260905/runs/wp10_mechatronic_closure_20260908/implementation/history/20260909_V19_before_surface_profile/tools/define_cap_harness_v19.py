...
for side,name,num in [(-1,'PLUS','1'),(1,'MINUS','4')]:
 ...
 assert start['S_face_mm']==[-7,14*side,-64]
 ...
 wires.append(dict(id='C203_W_'+name,from_feature='C203_PCB.WIRE_'+name,to_feature='CHB_INPUT_PCB.CAP_'+num,
  ...
  bend_radius_mm=10.0,strip_start_mm=4.1,strip_end_mm=3.6,
  insulation_start_S_mm=[-8,14*side,-64],insulation_end_S_mm=[-42,17.78*side,-78.7],
  conductor_tip_start_S_mm=[-3.9,14*side,-64],conductor_tip_end_S_mm=[-42,17.78*side,-82.3],
  C203_solder_projection_mm=1.5,CHB_solder_projection_mm=1.0))
inputs=['power/CAP_TERMINAL_DEFINITION.json','power/CHB_INPUT_DEFINITION.json','ecad/wp10_c203_terminal.kicad_pcb','ecad/wp10_chb_input.kicad_pcb','ecad/wp10_system.xml','mechanical/CHB_INPUT_INSTANCE_PLAN.json',wire['source_file']]
