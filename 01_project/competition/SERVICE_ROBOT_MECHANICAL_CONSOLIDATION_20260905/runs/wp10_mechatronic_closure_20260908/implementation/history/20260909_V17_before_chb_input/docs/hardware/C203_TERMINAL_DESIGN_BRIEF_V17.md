...
电容脚孔 local(-5,0)/(5,0)，孔径 2 mm。外接线焊孔改为 local(-14,14)/(14,14)，候选成品孔径 1.8 mm，焊盘外径 3.5 mm；焊盘自身距最大 Ø31 电容侧面投影约 2.55 mm，也处于 carrier 的 33 × 33 mm 开窗内。V17复核补充：4 mm走线圆端帽比焊盘多伸出0.25 mm，WIRE端实际铜包络侧隙2.29899 mm、开窗余量0.50 mm；均未含制造公差及焊接/线弯空间。四个 Ø3.4 mm 安装孔、外轮廓、定位及其他 964 实例的 STEP 不变。
