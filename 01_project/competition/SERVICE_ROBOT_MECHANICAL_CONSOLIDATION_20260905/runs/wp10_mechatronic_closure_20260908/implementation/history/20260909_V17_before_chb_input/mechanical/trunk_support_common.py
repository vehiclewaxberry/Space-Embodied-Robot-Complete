...
def make(name):
    ...
    if name in ['LOW_BASE','HIGH_BASE','CAP']:
        ...
        if name=='HIGH_BASE':
            # Coordinates local to the high cable axis(-95,1.5,45).
            ...
            s=s+foot+post+shelf
            for y in [-8,8]:s=s-bore(1.7,20,y=y)
        ...
        if name=='DECK':
            ...
            x0,y0,z0,x1,y1,z1=c['adapter_cut_window_mm'];s=s-block(x0,x1,y0,y1,z0,z1)
