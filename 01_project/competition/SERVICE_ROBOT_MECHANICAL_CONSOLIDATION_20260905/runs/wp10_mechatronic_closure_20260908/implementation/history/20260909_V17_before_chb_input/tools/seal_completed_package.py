...
Run directly after all V17 generation and publishing finishes. Do not wrap
...
guard=json.loads((A/'logs/native_delta_cap_mount_v17.run.json').read_text())
...
assert json.loads((A/'results/DELIVERY_DECISION.json').read_text())['revision']=='V17_NATIVE_C203_TERMINAL_AND_COPPER_AUDIT'
integration=json.loads((A/'results/CAP_TERMINAL_REVISION_INTEGRATION.json').read_text())
