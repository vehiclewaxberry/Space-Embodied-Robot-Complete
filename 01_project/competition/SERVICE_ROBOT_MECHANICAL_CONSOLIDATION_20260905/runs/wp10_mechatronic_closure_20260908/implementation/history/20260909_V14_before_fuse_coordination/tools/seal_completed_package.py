...
Run directly after all V14 generation and publishing finishes. Do not wrap
...
guard=json.loads((A/'logs/native_delta_input_cap_exact_final.run.json').read_text())
...
assert json.loads((A/'results/DELIVERY_DECISION.json').read_text())['revision']=='V14_C203_INSTALLATION_CANDIDATE'
