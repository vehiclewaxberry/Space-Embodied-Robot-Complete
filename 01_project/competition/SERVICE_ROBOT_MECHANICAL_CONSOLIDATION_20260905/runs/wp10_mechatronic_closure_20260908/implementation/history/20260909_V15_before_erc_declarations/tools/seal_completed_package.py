...
Run directly after all V15 generation and publishing finishes. Do not wrap
...
guard=json.loads((A/'logs/native_delta_cap_binding_v15.run.json').read_text())
...
assert json.loads((A/'results/DELIVERY_DECISION.json').read_text())['revision']=='V15_SELECTED_INPUT_FUSE_AND_NATIVE_BINDING'
integration=json.loads((A/'results/FUSE_REVISION_INTEGRATION.json').read_text())
