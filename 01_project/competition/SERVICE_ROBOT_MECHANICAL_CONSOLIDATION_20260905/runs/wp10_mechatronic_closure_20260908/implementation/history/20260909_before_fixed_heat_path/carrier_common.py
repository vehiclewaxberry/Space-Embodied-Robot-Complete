...
def thermal_pad():
 ...
 p=PARAMS;s=Box(p['tim_x_mm'],p['tim_y_mm'],p['interface_gap_mm'],align=(Align.CENTER,Align.CENTER,Align.MIN))
 ...
 s.label='WP10_TSP1600S_PROJECT_CUT_UNCOMPRESSED';s.color=Color(.93,.51,.60);return s
