...
reviewed={
 'power/CAP_HARNESS_DEFINITION_V19.json':'0f83f6563a59333dcd2e419eb76d64cbd8a0855a62f4d9000a0341ba53298b92',
 ...
 'results/CAP_HARNESS_PATH_V19.json':'2fd122edf29faf3dc74c20f7ea27f8014b416e1080a1533d9cfa2aa704c02fab',
...
out=dict(status='PASS_SCOPED_ANALYTIC_SOURCE_REPAIR',reviewer='/root/cap_terminal_review',method='Read-only source and JSON review; independent polyline-minus-circular-corner length arithmetic; lightweight in-memory counterexamples. No CAD/OCP/KiCad or images loaded.',
 independent_cut_length_mm=52.76307712195816,checks=22,faults_rejected=10,
