...
receipt={'schema':'WP10_SYSTEM_AUX_SUPPLY_INTEGRATION_V1','utc':datetime.now(timezone.utc).isoformat(),'status':'PASS_ACTUAL_REVISED_SUPPLY_HIERARCHY_NET_BINDINGS__SYSTEM_DESIGN_OPEN',
